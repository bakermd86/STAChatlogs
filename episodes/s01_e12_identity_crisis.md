...
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Our analysis of the sensor records indicate a smaller vessel<br />
...
![](../images/bachar.png)**Commander Bachar:** Foru hours<br />
...
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Nothing of parcilar note. It is a standard G-type binary star, four bodies, none habitable<br />
...
![](../images/murry.png)**Hailey Murry:** Transporter malfunction. I will fix it when I get back. What seems to be the issue here?<br />
...
![](../images/murry.png)**Hailey Murry:** Sorry, just trying to maintain physical coherency in this form, I need to make sure the hands do not start shaking uncontrollably.<br />
...
![](../images/skig.png)**Skig:** I'll get a data link set up<br />
...
![](../images/skig.png)**Skig:** It may not be attracted to the singularity, it could be stuck on it<br />
...
**Gra'lan:** Clearly they wanted to play Parieses Squares, not by nerfed federation rules. <br />
...
![](../images/baras.png)**Captain Baras:** What are you talking about<br />
**Geret:** Um....Errrrr<br />
...
![](../images/baras.png)**Captain Baras:** I already ordered the Twins to come up with a way to test the entire crew, what do you two have<br />
...
**Kolea:** Captain, I am entirely certain that Throk lacks the ability to conspire against anyone who has control of the food replicators.<br />
...
![](../images/malat.png)**Lt. Malat:** Apparently now I'm "a threat to the federation"<br />
...
![](../images/malat.png)**Lt. Malat:** Also: even if it does work, you're pretty likely to electrocute us. But I like it, drastic times call for drastic measures<br />
...
**Gra'lan:** Which tragically ended our relationship when she accidentally digested part of a Starfleet fusion reactor.<br />
...
![](../images/malat.png)**Lt. Malat:** I guess we're doing some serious crimes now<br />
...
**Gra'lan:** You can do it! Think buttery thoughts!<br />
...
**Throk:** What are odds that the Captain takes action against Star Base 34? <br />
...
**Kolea:** Can I ask a couple questions? As the remaining senior staff is here and the question of the away team has come up.<br />
...
![](../images/zerra.png)**Dr. Zerra:** Ah whatever, I thought this plan sucked anyways<br />
...
![](../images/malat.png)**Lt. Malat:** Fascinating information, but I'm not sure how that helps here<br />
...
**Gra'lan:** You don't keep your 2FA backup codes written on a piece of fortune cookie paper attached to the inside of your comm badge like everyone else?<br />
...
![](../images/bachar.png)**Commander Bachar:** Skig, if you poison my body to death while you're inside of it, nobody will be left to care for the Lister<br />
...
![](../images/murry.png)**Hailey Murry:** Yes subcommander, let's see what is going on.<br />
...
![](../images/murry.png)**Hailey Murry:** Okay... skip the cloak, drop the Z-plane by 20km, and rig for no signature emissions.<br />
...
![](../images/murry.png)**Hailey Murry:** Even in the mirror universe, the Klingons like a good drink.<br />
...
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** That's your stretch goal.<br />
...
![](../images/murry.png)**Hailey Murry:** What I'm offering you is some more prime and free-range humans.<br />
...
![](../images/zerra.png)**Dr. Zerra:** It means I am Krepeka and the Dr is in my jello body.<br />
...
**T'kor:** I'm going to need a lot of duct tape<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Perhaps you should consider taking immediate action before you suffocate or freeze<br />
**T'kor: [ FITNESS  (9) +  ENGINEERING  (4)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 22]**<br />
**T'kor: [ DARING  (9) +  ENGINEERING  (4)]
...
![](../images/zox.png)**Zox:** Ah, so happy to have proper claws again.<br />
![](../images/skig.png)**Skig:** Which is only necessary because SOMEONE decided that Roman Empire 200 BC battle tactics is how starships operate!<br />
![](../images/murry.png)**Hailey Murry:** This isn't even the first time, is it?<br />
![](../images/skig.png)**Skig:** In that case, I think Keel-hauling the Landlubber who did it should be acceptable, and advance us into the 1600s atleast.<br />
![](../images/zox.png)**Zox:** I don't think we have the time to properly justify my behaviors. Briefly, When I heard neraran was on board, I knew nothing we have would be PPE for novel compounds, nor would our training be sufficient. Only drastic...heroic action could vent it off, and all of our crew is both equipped and trained to deal with zero-g and/or vaccum.<br />
**Kolea: [ INSIGHT  (11) +  SECURITY  (2)]
[Focus: Survival ]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 6]**<br />
![](../images/skig.png)**Skig:** Indiscriminately damaging the Lister by using it as a bludgeoning device is not an acceptable way to address the problem.<br />
![](../images/malat.png)**Lt. Malat:** Hard to argue with what works<br />
![](../images/zox.png)**Zox:** That attack angle was calculated...indiscriminate, pah!<br />
**Kolea: [ DARING  (9) +  MEDICINE  (4)]
[Focus: Syndicate Training ]
[Successes: 3] [Complications: 0]
...
![](../images/bachar.png)**Commander Bachar:** Skig, stop complaining about it and get life support stabilized<br />
![](../images/bachar.png)**Commander Bachar:** It is inevitable: if I give Zox command, something will get broken. Let's not act surprised about it<br />
**Kolea:** With all due respect to the various dissenting members of the command staff, I have a small bubble of goo that is the current conscious remains of Neraran trapped in Sickbay. Commander Bachar, can you take custody of it from me so I can resume working on medical emergencies?<br />
*Skig cuts off comms and resumes working on life support and other systems that Zox damaged.*<br />
![](../images/bachar.png)**Commander Bachar:** I'll be right there. Malat, you head to the bridge and resume course for Starbase 34. <br />
...
![](../images/bachar.png)**Commander Bachar:** Are we back under control? Or are there any other emergencies threatening to destroy the ship today?<br />
![](../images/murry.png)**Hailey Murry:** We'll need to do a thorough sweep to be sure<br />
...
![](../images/zerra.png)**Dr. Zerra:** Scanning sectors 4 through 20 for novel, volatile, or dangerous compounds...<br />
![](../images/bachar.png)**Commander Bachar:** Ok, if we are otherwise out of danger: senior staff, head to the briefing room<br />
**Geret:** Commander, one Ensign Geret cannot be located!<br />
![](../images/zox.png)**Zox:** Commander, one Ensign Geret cannot be located!<br />
**T'kor: [ INSIGHT  (7) +  SECURITY  (2)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 18]**<br />
![](../images/malat.png)**Lt. Malat:** Oh yeah, she is stuck as a Horta in the brig<br />
**Hailey Murry: [ INSIGHT  (13) +  SECURITY  (3)]
[Successes: 0] [Complications: 0]
Failed on DC: 1 [2d20 = 35]**<br />
![](../images/malat.png)**Lt. Malat:** I'll send a repair team to go cut her out and see if they can get the slag cleaned off her<br />
*Zox looks dumbfounded.*<br />
*Zox toots the wootle of confusion.*<br />
![](../images/skig.png)**Skig:** I would ask questions... but at this point I feel the answers may annoy me more.<br />
![](../images/skig.png)**Skig:** Also, Throk apparently used some glue on the emergency punch cards needed to reboot life support and was making them into S'mores.<br />
**Zox: [ CONTROL  (11) +  SECURITY  (5)]
[Focus: Espionage ]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 33]**<br />
**Kolea:** Speaking of which, crewman Throk is currently recovering but has both collapsed lungs after, I shall call it heroically, choosing to eat several vials of Neraran's chemical grenades.<br />
![](../images/bachar.png)**Commander Bachar:** We can transfer him to the medical facility on Starbase 34. They are properly equipped to clone him new organs<br />
![](../images/zox.png)**Zox:** Oh no! Poor Throk!<br />
*Kolea sits down in chair painfully, as certain internal organs are not happy being jostled right now.*<br />
**Kolea:** Thank you Commander.<br />
**T'kor: [ INSIGHT  (7) +  ENGINEERING  (4)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 18]**<br />
**Kolea:** We have 69 various injuries throughout the ship caused due the recent 90 minutes of activities. Of course, at least a dozen of them were papercuts near the pelvic regions of multiple crew who insisted I visually verify they were okay.<br />
<font color="#005500">indarien (Kolea): BRB</font><br />
*Zox looks at a Pad.*<br />
![](../images/zox.png)**Zox:** How did Gra'lan get put in the brig?<br />
**T'kor:** I believe the Twins are currently operating a remote medical bot<br />
![](../images/zox.png)**Zox:** If he was a mole, he literally spent two lifetimes under cover.....<br />
...
**T'kor:** Where are you two right now? <br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** We are right here Ensign<br />
*T'kor pokes 11*<br />
>T'Kor's finger passes directly through 11's head<br />

**T'kor:** Ah, yes, carry on<br />
![](../images/bachar.png)**Commander Bachar:** why are the Twins a hologram?<br />
![](../images/bachar.png)**Commander Bachar:** Anyone have an explanation?<br />
**Zox: [ INSIGHT  (7) +  SECURITY  (5)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 18]**<br />
*Zox thinks hard.*<br />
**Kolea:** Those are medical scanning bots being remotely controlled to test for the presence of changelings and shapeshifters. Also, to help monitor for the location of various suspicious crew who had been behaving oddly.<br />
**Zox: [ CONTROL  (11) +  SECURITY  (5)]
[Focus: Espionage ]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 24]**<br />
**Kolea:** The Twins themselves are theoretically in a safer location in case we had to deal with a mass casualty event and needed command crew capable of getting the Lister to the Starbase while being securely away from the primary life support systems.<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** We are not being remotely controller, we are a holoprogram which your Bynar crewmembers created using a shallow copy of their behavioral matrix several months ago<br />
![](../images/zox.png)**Zox:** Okay.....<br />
**Kolea:** Sorry, I think I was being gassed during the previous explanation, thank you for the clarification.<br />
![](../images/bachar.png)**Commander Bachar:** So where are the Twins?<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** We are not programmed with that information<br />
![](../images/zox.png)**Zox:** Not on this ship, Commander.<br />
![](../images/murry.png)**Hailey Murry:** I think we should find them in case something happened. We don't know for sure if there wasn't another trap that they got caught in<br />
![](../images/zox.png)**Zox:** One hypothesis is that they boarded a remote probe<br />
**Zox: [ CONTROL  (11) +  SECURITY  (5)]
[Focus: Espionage ]
[Successes: 3] [Complications: 0]
...
![](../images/murry.png)**Hailey Murry:** What was the trajectory on that probe? <br />
![](../images/zox.png)**Zox:** Yep, I'd be they boogied out on proble 3456-J<br />
**Hailey Murry: [ REASON  (9) +  CONN  (3)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 16]**<br />
*Zox The lister is just a penetration test. *<br />
![](../images/bachar.png)**Commander Bachar:** Ok, so: The Captain is medically incapacitated, Dr. Zerra's mind is missing, Krepeka's body is currently host to a genocidal chemical weapons expert, and the Twins are flying off in a probe somwhere<br />
![](../images/bachar.png)**Commander Bachar:** Are there any other ongoing catastrophes I should be aware of?<br />
![](../images/murry.png)**Hailey Murry:** It seems that the probe is heading toward Earth. I think it's a good idea to report it as potentially having some chemical or software issues<br />
**Kolea:** Curious. Sorry, ideas but nothing further to add there.<br />
![](../images/murry.png)**Hailey Murry:** I think we should shut down all the Twin bots<br />
![](../images/bachar.png)**Commander Bachar:** I'll file a report on it to Starfleet security<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Before you shut us down, your Bynar crewmembers did request that we convey their regret over having to leave so suddenly<br />
![](../images/murry.png)**Hailey Murry:** Did they state a reason? <br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** They did not ellucidate, merely that it was essential for the security of the Federation and they did not have time to explain further<br />
...
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** We were not created for this purpose, so we are not programmed witha access to this information<br />
**Zox: [ DARING  (12) +  SECURITY  (5)]
[Focus: Shipboard Tactical Systems ]
[Successes: 3] [Complications: 0]
...
![](../images/zox.png)**Zox:** All Twin-Bots are now in a simulation in Holodecks 12-17, complete with zaney escapades.<br />
![](../images/zox.png)**Zox:** If anyone has false-intel to feed to them, let me know.<br />
![](../images/bachar.png)**Commander Bachar:** Murry, go find out what they know. Take whoever you need. I have to go file a report on this before we arrive at Starbase 34<br />
**Kolea:** Just don't activate the Throk Team-Building BBQ Extravaganza that he programmed while you were away.<br />
![](../images/bachar.png)**Commander Bachar:** Skig, get a head-start on the repairs, I don't want to spend any more time at Starbase than we have to before we head out again<br />
![](../images/skig.png)**Skig:** Yes Commander.<br />
![](../images/zox.png)**Zox:** We have to have some insanity to present a convincing facade. I saw a human movie about this once...<br />
**Kolea:** Can we figure out how to "undo" the transporter situation so Neraran ends back up in Zerra's body and Krepeka is back to normal goo form?<br />
**Kolea:** We also need to track down the real Dr Zerra.<br />
![](../images/zox.png)**Zox:** Yes, Very much so Kolea....<br />
*Kolea coughs delicately and wipes frothy blood away from her mouth.*<br />
**Kolea:** Hmm... probably time for some meds.<br />
![](../images/bachar.png)**Commander Bachar:** Kolea and Viraseti can take point on figuring out the body swapping. Murry and Zox can take point on tracking down the Twins<br />
![](../images/bachar.png)**Commander Bachar:** Dismissed<br />
...
![](../images/murry.png)**Hailey Murry:** Well, this is quite a pickle <br />
![](../images/zox.png)**Zox:** There has to be something left in the Twins' memory we can get to here. <br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Our program is part of this simulation, so when Commander Zox transfered us here, it activated this program<br />
*Zox puts on a detective fedora*<br />
![](../images/murry.png)**Hailey Murry:** What are the parameters for your program?<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** We were created in order to participate in a casino robbery here in the holodeck with yourselves and several other crewmembers. Our instructions were to ensure that all relevant parties spent as much time as possible in the holodeck over the course of three days, and to notify Lt. Commanders 11 and 10 whenever any of you left the holodeck<br />
![](../images/murry.png)**Hailey Murry:** I see, were 11 and 10 ever in the simulation with us?<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Yes, they wanted to participate in the final robbery itself as that was anticipated to be "fun"<br />
*Zox carefully lines up a white hat, a red hat, and a black hat on a bench.*<br />
![](../images/zox.png)**Zox:** pick one.<br />
*Hailey Murry picks the bench, sitting down beside them*<br />
![](../images/murry.png)**Hailey Murry:** Did the twins have a stated reason? <br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** They did not include that information in our programming. <br />
![](../images/zox.png)**Zox:** Just who gave you this holodeck program?<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** As far as we are aware, 11 and 10 created this program themselves<br />
**Juan Toby:** AAAGGGGHHHHH!H!H!H!H!H!<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** They are expert holoprogrammers<br />
*Juan Toby smashes through the ceiling and lands on the ground, smoke rising from his clothes.*<br />
**Juan Toby:** DAMN ALIENS!<br />
![](../images/murry.png)**Hailey Murry:** Oh? So this was not a gift from a friend of theirs? <br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** As far as we are aware, no<br />
**Juan Toby:** Where am I?<br />
![](../images/zox.png)**Zox:** I don't think they made this, as they stated it was from someone else, with quantum encrypted data rewards<br />
*Juan Toby looks suspiciously and wild-eyed at everyone.*<br />
![](../images/zox.png)**Zox:** Juan! My man!<br />
*Zox offers Juan a cig*<br />
*Juan Toby takes cig, sniffs it, lights it with embers from his smouldering hair.*<br />
**Juan Toby:** OOHOHHH YEAH. That's the good stuff.<br />
![](../images/murry.png)**Hailey Murry:** So what... why did the Twins create this simulation? <br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** That was intended as a plausible explanation to allay your suspicions as to why they had a compatible region of memory already configured to contain quantum encrypted data. They were supervising your efforts to access the datapad, and anticipated that you would require such a memory region to store the data once accessed<br />
![](../images/murry.png)**Hailey Murry:** And also, they thought the climax would be fun<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** As to why they created THIS simulation in particular: they have a fondness for Earth films of this era<br />
![](../images/zox.png)**Zox:** They should have tried 67,000,000 BC. <br />
![](../images/zox.png)**Zox:** Best time really.<br />
**Hailey Murry: [ INSIGHT  (13) +  ENGINEERING  (1)]
[Successes: 0] [Complications: 1]
Failed on DC: 1 [2d20 = 38]**<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Murry attempts to access the program memory, but inadvertently trips a security program embedded in their subroutines, and their entire program is erased<br />
...
![](../images/murry.png)**Hailey Murry:** Oh dang it<br />
<font color="#005500">Masakari (Ishemok): (NOT JUAN NOOOOO)</font><br />
**Juan Toby:** WHAT A WORLD....<br />
**Juan Toby:** Man...I'm melting from the feet up and losing my sense of taste.<br />
**Juan Toby:** Great to see you again, crazy dinosaur man.<br />
![](../images/zox.png)**Zox:** Heck yeah! I thought for sure you were a gonner in that wreck, but you stuck it to the man!<br />
>Murry and Zox watch the entire 1970s world dissolve around them until they are left standing in an empty holodeck<br />

![](../images/murry.png)**Hailey Murry:** I'm sorry for your loss, Zox<br />
*Juan Toby high fives Zox as he vanishes into the quantum ether.*<br />
![](../images/zox.png)**Zox:** I wish Starfleet had people of that caliber.<br />
![](../images/zox.png)**Zox:** Anyway....<br />
...
**Hailey Murry:  [4d20 = 38]**<br />
![](../images/bachar.png)**Commander Bachar:** I just got out of a meeting with the command staff on Starbase 34: Captain Baras failed the competency exam, he is no longer fit for duty as a Starfleet Officer after all the drugs Neraran filled him up with<br />
![](../images/zox.png)**Zox:** Congratulations Commander!<br />
![](../images/murry.png)**Hailey Murry:** What Zerra did to him, complicitly, is unforgiveable <br />
![](../images/bachar.png)**Commander Bachar:** We contacted his family and his daughter is going to come pick him up and take him back to Benzite<br />
![](../images/bachar.png)**Commander Bachar:** We contacted his family and his daughter is going to come pick him up and take him back to Benzar<br />
**Skig:  [4d20 = 35]**<br />
![](../images/bachar.png)**Commander Bachar:** In the meantime...<br />
...
![](../images/bachar.png)**Commander Bachar:** "By order of Starfleet Command division of Exploration and Strategic Operations: in light of recent staffing challenges at the Captain rank, and recent circumstances: we hereby bestow upon Commander Amondi Bachar the rank of Captain, with all the rights and privileges thereof."<br />
**Kolea:** Congratulations Captain Bachar.<br />
![](../images/bachar.png)**Captain Bachar:** This leads to our secord order of business: we suddenly find ourselves with some staffing challenges of our own<br />
![](../images/zox.png)**Zox:** I feel like im going to be replaced, like im some sort of dinosaur...<br />
<font color="#005500">Masakari (Zox): Conscript the romulans!</font><br />
<font color="#005500">Masakari (Zox): Juan!</font><br />
![](../images/bachar.png)**Captain Bachar:** Most pressingly: I need a first officer. Someone that I can trust to lead away teams, command the Lister, and issue orders in the best interest of the ship and crew. And while I have not always seen her value as an officer: Lt. Commander Skig is the obvious choice to me<br />
*Captain Bachar tosses a gold rank pip across the table to Skig*<br />
*Skig blinks.*<br />
*Hailey Murry applauds politely*<br />
![](../images/skig.png)**Skig:** I...uhh.... thank you ma'am.<br />
![](../images/zox.png)**Zox:** Such Leadership! Much challenging values and views!<br />
![](../images/zox.png)**Zox:** very starfleet.<br />
![](../images/bachar.png)**Captain Bachar:** When I first met you, I thought you were arrogant and dismissive of the lives of your crew, but I have come to respect your judgement and your abilities and I will be relying on you moving forward<br />
![](../images/bachar.png)**Captain Bachar:** Now, we also need an ops officer. And I cannot believe what I am about to say: But Commander Zox, you are my first choice to fill the position<br />
![](../images/skig.png)**Skig:** I hope your judgment is not misplaced. I shall... endeavour to get my head out of engineering.<br />
![](../images/bachar.png)**Captain Bachar:** Every plan you come up with sounds like the stupidest thing I have ever heard, but.. somehow it always seems to work out<br />
![](../images/zox.png)**Zox:** I accept this honor, Commander!<br />
![](../images/bachar.png)**Captain Bachar:** I really have no explanation, but I need that kind of decision making at ops<br />
*Skig requisitions extra ramming buffer around the structure.*<br />
*Zox 's scales flush several colours.*<br />
![](../images/bachar.png)**Captain Bachar:** And now that I am in command, we don't need to carry out this investigation in the dark anymore. From this point on, we are going to focus our actual resources on this investigation and we will get to the bottom of it. To that end, I am appointing Lt. Commander Murry as our Strategic Operations Officer and putting her in charge of heading the investigation<br />
![](../images/bachar.png)**Captain Bachar:** At some point in your career: someone thought you would make a good counselor. I have no idea why, you should have been funneled into Starfleet Intelligence in my opinion<br />
<font color="#005500">KruschtyaEquation (Hailey Murry): Zox's Cafe: It's a Whoot!</font><br />
![](../images/murry.png)**Hailey Murry:** Well thank you, I think<br />
![](../images/bachar.png)**Captain Bachar:** To replace Zox at Security and Tactical, I wanted someone from the Lister we could trust. Lt. Commander Malat will be filling his boots<br />
*Zox slips two 'get out of the brig free' cards to Malat*<br />
![](../images/bachar.png)**Captain Bachar:** That does still leave us with a need for a new Conn officer, chief engineer, CMO and Counselor<br />
![](../images/bachar.png)**Captain Bachar:** Ensign T'Kor seems like the obvious choice to me for Chief Engineer, and Nurse Kolea is qualified to take over as CMO given her experience<br />
![](../images/bachar.png)**Captain Bachar:** As for our new Conn officer and Counselor, they will be beaming over soon. We should go greet them in transporter room 2<br />
**Kolea:** Thank you ma'am, I shall endeavor to keep the crew healthy.<br />
**T'kor: [ CONTROL  (11) +  ENGINEERING  (4)]
[Focus: Repair/Tinkering ]
[Successes: 3] [Complications: 0]
Success with 2 momentum [2d20 = 9]**<br />
**Hailey Murry:  [Total: 2] [Effects: 2] [4dChallenge = 2]**<br />
...
**Windbloom Openheart:** Far out! Such a trip man<br />
*Zox bows deeply before the Tao-master.*<br />
**Ensign Ghex:** Ensign Eudoria Ghex reporting for duty as ordered Ma'am! Sir! Ma'am?<br />
**Kolea:** Windbloom, it is great to see you!<br />
**Ensign Ghex:** I know that the regulation says that it should be "Sir", I mean I do OBVIOUSLY know the regulations, but that always kind of seemed weirdly patriarchal to me<br />
...
**Kolea:** It's an honorific Ensign Ghex, and understandable. I am medical officer Kolea.<br />
**Ensign Ghex:** I'm not really sure, but... Sorry, sometimes I talk too much when I'm nervous.<br />
*Ensign Ghex chuckles nervously*<br />
**Kolea:** There are all manner of strange traditions in Starfleet.<br />
**Kolea:** You are fine.<br />
*Zox toots the wootle of greetings.*<br />
**Windbloom Openheart:** It's so cool to see you again too Kolea, I was totally surprised when Amondi contacted me but super jazzed to come out here and help <br />
**Windbloom Openheart:** I brought this with me too for therapy sessions<br />
...
![](../images/bachar.png)**Captain Bachar:** I had to be careful about who we brought on board, to ensure that they weren't involved in whatever conspiracy Zerra and Neraran are caught up in<br />
**Kolea ** *(whispers)*: These two are probably pretty safe.<br />
![](../images/bachar.png)**Captain Bachar:** Windbloom is far too much of a pacifist, and Ghex didn't stop talking long enough for me to get a question in when I interviewed her<br />
![](../images/bachar.png)**Captain Bachar:** No way she is involved in it<br />
**Ensign Ghex:** Yes ma'am, sir. No way. Involved in what? Is it good or bad?<br />
**Kolea:** It is good.<br />
**Windbloom Openheart:** Don't worry about it little one, it's all good<br />
![](../images/bachar.png)**Captain Bachar:** I'm sure you're both tired from your trip, the computer can help you find your quarters. Ensign Ghex, get some rest. I expect you to report for your shift on the bridge tomorrow morning as scheduled<br />
*Ensign Ghex salutes so hard she bounces up in the air a little bit*<br />
**Ensign Ghex:** Yes Ma'am! Sir!<br />
...
![](../images/bachar.png)**Captain Bachar:** Were any of you ever that young?<br />
**Kolea:** Yes, by then I had killed at least 200 people and was trained in 14 methods for sensuous murder.<br />
**Windbloom Openheart:** Age is just a number man, Jem'Hadar are fully grown at 2 of your years<br />
![](../images/murry.png)**Hailey Murry:** God<br />
![](../images/zox.png)**Zox:** It was glorious, wrestling with my entire clutch!<br />
![](../images/zox.png)**Zox:** the smallest of reptiles. the biggest of competitions!<br />
![](../images/skig.png)**Skig:** According to legend, I was carved from the original warp core of the Lister. I believe that is what the engineers whisper behind my back.<br />
![](../images/bachar.png)**Captain Bachar:** Well Murry was there, maybe she can confirm or deny<br />
![](../images/murry.png)**Hailey Murry:** My lips are sealed on that matter<br />
![](../images/skig.png)**Skig:** Probably for the best.<br />
**Zox: [ REASON  (7) +  SECURITY  (5)]
[Focus: Xenobiology ]
[Successes: 0] [Complications: 1]
Failed on DC: 1 [2d20 = 35]**<br />
...
![](../images/bachar.png)**Captain Bachar:** Regardless, everyone should get some rest. Right now we have half a new crew, a crazed chemical terrorist in the brig, and the only concrete lead we have is a track on a probe that may have the Twins on it. We are heading out for Earth first thing in the morning<br />
**Kolea:** Yes Captain.<br />
![](../images/bachar.png)**Captain Bachar:** I would say something inspiring and hopeful, but I'm not that sort of captain. If you need to be inspired, you're going to have to look elsewhere. The best I can do is to say that I expect all of your best in the coming days and weeks.<br />
![](../images/bachar.png)**Captain Bachar:** The entire fleet thinks this ship is a laughing stock, let's try not to prove them right<br />
![](../images/murry.png)**Hailey Murry:** Yes ma'am<br />
![](../images/zox.png)**Zox:** This ship has seen things those officers wouldn't believe!<br />
...
![](../images/malat.png)**Lt. Cmdr Malat:** Your average children's holoprogram has seen things too mature for Ensign Ghex<br />
![](../images/zox.png)**Zox:** We need an orko or snarf though.<br />
![](../images/zox.png)**Zox:** Oh wait...<br />
*Zox blames the weed.*<br />
![](../images/bachar.png)**Captain Bachar:** And Zox: For your first shift at Ops tomorrow, I expect you to be sobered up and with your pants on<br />
**Kolea:** I'm sure Ghex will bloom into a wonderful and capable Starfleet officer, although I will mention that she needs to use less strawberry body wash lest Throk think she is a walking snack.<br />
![](../images/zox.png)**Zox:** A...r...Okay.<br />
