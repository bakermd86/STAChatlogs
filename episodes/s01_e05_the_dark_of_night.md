...
![](../images/bachar.png)**Cmdr Bachar:** cracks a slight grin<br />
...
![](../images/bachar.png)**Cmdr Bachar:** Counselor Murry, I realize that ship's counselor is not the most critical combat role. But in the event of an emergency, I expect that all of the senior staff will be at their posts in under 2 minutes.<br />
...
![](../images/zox.png)**Zox:** it is safe and there are sentient beings potentially in harm's way!<br />
...
![](../images/zox.png)**Zox:** Even just a little bit to find out what happened here.<br />
...
![](../images/baras.png)**Captain Baras:** Nothing recently, but we lost many ships in this area during the war<br />
...
![](../images/zerra.png)**Dr. Zerra:** To stablize his condition until we are able to analyze further<br />
...
![](../images/zerra.png)**Dr. Zerra:** The lifesign I'm reading is just inside there<br />
...
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 25]**<br />
![](../images/zerra.png)**Dr. Zerra:** Wait, what happened to my tricorder?<br />
...
![](../images/zox.png)**Zox:** I have no idea how these things changed places<br />
...
![](../images/murry.png)**Hailey Murry:** "Us" are the crew of the USS Aubery, the vessel I was first assigned to. "Them" being the backstabbing, mutineering, underhanded, dishonest bastards who left us stranded on an uncharted Class M we were researching<br />
...
**Kolea:** Her heart rate is reaching dangerous levels for a human and her blood oxygen level is dropping.<br />
...
![](../images/zox.png)**Zox:** ...What is Murry infected with?<br />
...
![](../images/skig.png)**Skig:** That sound I hear? That is the sound of ultimate suffering, the Lister made is when Hailey blew up part of the ship, Zox makes that now when he realizes I put reinforced rebar plascrete on the briefing room doors.<br />
...
![](../images/skig.png)**Skig:** Perhaps have Skig check to see if there is some residual power source from something on the Aubrey which is jamming or disabling life support in a contained field, like a warp bubble, around it, and the Lister has been caught in the field generated by it.<br />
...
![](../images/skig.png)**Skig:** In that situation, the reinforced rebar protective shielding would have sealed the door.<br />
...
![](../images/bachar.png)**Cmdr Bachar:** And a phaser?<br />
...
![](../images/zox.png)**Zox:** I think we need to figure out more what they wanted to sell, that tells you everything you need to know.<br />
...
![](../images/bachar.png)**Cmdr Bachar:** Did you fell your body dematerialize into a trillion particles and come back together again?<br />
...
![](../images/zox.png)**Zox:** My tail hurts<br />
...
![](../images/zerra.png)**Dr. Zerra:** And check if anyone has BINGO yet<br />
...
![](../images/zerra.png)**Dr. Zerra:** Counselor Murry, have you had any prior brain surgery that isn't in your official medical file?<br />
...
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Commander Zox, we attempted to call you but comms appear to be offline<br />
...
![](../images/zerra.png)**Dr. Zerra:** Well, I am afraid that is a little outside my area of expertise. All I can say is that whatever did this didn't cut through her skull to do it. It's as if it materialized in there<br />
...
![](../images/zox.png)**Zox:** We are going to have to run a level 2 diagnostic when Skig is back.<br />
**Zox: [ REASON  (7) +  SECURITY  (4)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 16]**<br />
...
![](../images/zox.png)**Zox:** Hailey, gimme your phaser!<br />
...
![](../images/zox.png)**Zox:** Excellent!<br />
...
![](../images/bachar.png)**Cmdr Bachar:** Good point Lieutenant, suggestions<br />
**Ishemok:** Drugs.<br />
...
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Oh, you could say that<br />
...
![](../images/bachar.png)**Cmdr Bachar:** I have no idea what is going on here, but I don't mind having a welded shut door between us<br />
...
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** But before I realized he was a changeling, he got security on his side and they tried to arrest me for carrying a phaser rifle into the bridge<br />
...
**Kurij: [ INSIGHT  (10) +  ENGINEERING  (1)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 19]**<br />
...
**Ishemok:** Wait<br />
**Ishemok:** What currencies do these warp creatures barter in...<br />
...
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Commander, your plan seems not to have had the desired effect<br />
...
![](../images/skig.png)**Skig:** I suspect Murry's former crewmember may have answers in that regard, even if the crewmember herself does not know it.<br />
...
![](../images/skig.png)**Skig:** The injured Taganite.<br />
...
![](../images/murry.png)**Hailey Murry:** What is that? <br />
**Zox: [ INSIGHT  (8) +  SECURITY  (4)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 27]**<br />
...
**Kolea:** Come on Zox! We must rescue the captain from whatever is happening!<br />
...
![](../images/baras.png)**Captain Baras:** Flood the jeffries tubes with neurozine gas! Flush them out like rats!<br />
>♫♫♫Dramatic Music String♫♫♫<br />
...
![](../images/zerra.png)**Dr. Zerra:** Does the computer seem unusually chatty to anyone else?<br />
...
![](../images/skig.png)**Skig:** I'm going to pretend that line NEVER existed.<br />
...
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** That I can't say, some exploratory brain surgery might give us a better idea<br />
...
![](../images/zox.png)**Zox:** Skig, this sounds like people trying to do some engineeering. Maybe instead of cutting open 5 skulls, we can patch one subspace string?<br />
...
![](../images/murry.png)**Hailey Murry:** Zox, would you like to intercept? <br />
...
![](../images/zox.png)**Zox:** Those things need documents ya know?<br />
...
![](../images/skig.png)**Skig:** I surmise that would merely stretch the cosmic string out and create a tympanic response when it reached its limit before snapping back in an uncontrolled direction that might damage my beautiful Lister.<br />
...
![](../images/zox.png)**Zox:** Might I suggest that Hailey Murry and this mutineer need to use constructive dialogue to resolve this subspace gap; clearly something from their past has some sort of pan-dimensional gravity and perhaps needs to be counseled away.<br />
...
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** We hate to interrupt, but the captain's security team is now approaching your position<br />
...
![](../images/murry.png)**Hailey Murry:** Vent it, please<br />
...
![](../images/skig.png)**Skig:** I had not noticed people were behaving oddly, is this a new thing I should have been paying attention to?<br />
...
![](../images/zerra.png)**Dr. Zerra:** So no idea what horrors you will see there<br />
...
![](../images/skig.png)**Skig:** Dammit, I meant Override Epsilon Carnivore 7, I will have to try that next round.<br />
>[TURN] Skig<br />
...
![](../images/skig.png)**Skig:** Careful evaluation of Jem Hadar determined that a random execution chompy door program was proven to brutalize the Hell out of boarding parties by inflicting grievous casualties to the Jem Hadar by removing their limbs.<br />
...
![](../images/zox.png)**Zox:** Have they eaten too much skunk-cabbage?<br />
![](../images/zerra.png)**Dr. Zerra:** They're all going into some sort of neurological shock, but there's no obvious cause. <br />
![](../images/skig.png)**Skig:** I'm sure, in the future, Star Trek vessels will get equipped with the appropriate solution based on your recommendations.<br />
![](../images/zox.png)**Zox:** Do you need me to get an assortment of confiscated narcotics, doctor?<br />
![](../images/zerra.png)**Dr. Zerra:** Maybe later, we're working now.<br />
![](../images/skig.png)**Skig:** The question is, does the cosmic string dissipate with their deaths?<br />
>Meanwhile, inside the mind meld J'Davir and Murry watch as Lt. Elin collapses to the floor, crying out in anguish<br />

![](../images/zerra.png)**Dr. Zerra:** We have a little bit of time, but something is dampening their neurological functions. Any assistance would be welcome...<br />
**J'Davir:** Lt Elin, now is not the time for you to die, releasing your anger may have kept you alive this long, but you need to perservere through this and hold Murry to getting your soup recipe back.<br />
**Kurij:** What do you need, Doctor? <br />
**Ishemok:** Rule 345: Angry people are better customers than dead people<br />
**Hailey Murry: [ INSIGHT  (12) +  COMMAND  (1)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 29]**<br />
![](../images/zerra.png)**Dr. Zerra:** I don't know what this sting is doing to their nurological functions, but until it is stopped it's going to suck them dry<br />
![](../images/skig.png)**Skig:** Viraseti, can you assist me in a scan of the area to see if we are getting a harmonic dissonance that is triggering a neuroloical feedback function?<br />
![](../images/zerra.png)**Dr. Zerra:** I've bought us a little time, but if we don't do something we're going to lose all 3<br />
**Ishemok: [ INSIGHT  (9) +  SCIENCE  (2)]
[Focus: Philosophy ]
[Successes: 1] [Complications: 0]
Success with 0 momentum [d20 = 9]**<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Fascinating, good work on your detailed scanning records Ensign Ishemok. When this is done, I am definitely having you transfered to stellar phenomena.<br />
**Ishemok:** Oh! That's music to my ears! a promotion!<br />
![](../images/zox.png)**Zox:** Music you say? Maybe that would calm down these disturbed psyches...<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** It seems that the high reckless mind meld experiment has had an effect on the balance of neurological energy feeding the system. Previously, Elin and Murry were both producing an excess of neurological fields associated with their anger, but now those fields have dissipated <br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** But as the string is collapsing, it seems to be pulling whatever neurological energy it can from each end<br />
**Ishemok:** Should we all induce sleep and watch it starve?<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Like a vacuum, drawing all the air from an open airlock<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Pretty sure that would kill them both<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** And possibly J'Davir as well, I am not an expert on mind melds<br />
**Kurij:** Well, that doesn't sound optimistic<br />
**Kurij:** Is there a way that we can each take a bit of the load off so it doesn't kill everyone as it dissipates? <br />
![](../images/zox.png)**Zox:** What about all getting super emotional and excited so it drains from all of us instead of these angry people?<br />
![](../images/skig.png)**Skig:** Would we rather have it dissipate through starvation, as Ishemok proposed?<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Like a blood donor? Interesting idea, but you would need to figure out a way to move it from one of their brains into your own<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** And the risks are incalculable<br />
![](../images/zerra.png)**Dr. Zerra:** Don't say it is dangerous, Zox will want to do it even more<br />
![](../images/skig.png)**Skig:** We might also want to consider just breaking the mind-meld; however that would be performed.<br />
![](../images/zerra.png)**Dr. Zerra:** I have never dealth with a failing mind meld before, I have no idea the risks if we sever it. If we had a few hours I would consult the medical literature, but I doubt we have that long<br />
![](../images/skig.png)**Skig:** Viraseti, would it be possible to determine what is causing the string to tether to them?<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** The string is mostly contained in subspace, so I can think of only 3 possiblities:<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** One: they may have encountered the string during traversal through a wormhole<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Two: They could have hit it at exactly the wrong time while dropping out of warp, when the ship croses though the warp threshold into normal space<br />
*Skig is secretly hoping one of these options involves exploratory brain surgery.*<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Or Three: If the matter confinement beam of a transporter intersected the string directly<br />
![](../images/skig.png)**Skig:** I could completely imagine the third one being likely given what little I have learned of the situation.<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** As to severing it, if we could find way to give the string a tug we could do so just as we also cross a subspace threshold<br />
![](../images/zox.png)**Zox:** A technical solution presents itself!<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Either with the transporter or the warp engines, but I am not sure how we could reliably find a way to "tug" the string<br />
![](../images/skig.png)**Skig:** That seems like an engineering problem, thank you Lt. Cmdr Viraseti<br />
**Kurij:** Is this going to be something where the "rip it off" mentality will be non-lethal?<br />
**J'Davir: [ FITNESS  (9) +  COMMAND  (1)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 26]**<br />
**Hailey Murry: [ FITNESS  (7) +  COMMAND  (1)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 18]**<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** I can't say Kurij, but there is only one way to find out<br />
![](../images/zox.png)**Zox:** Quartermaster, do you think there were some subspace weapons on the freighter?<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Apologies for interrupting, but we have completed a full review of all 132,451 published articles on mind melds in the Starfleet medical database<br />
**Ishemok:** Can mind-melds form the basis of more efficient advertising targeting?<br />
**Kurij:** Ishemok, this is not the time<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Severing a mind meld is a generally risky proposition, however a meta-analysis seven years ago by the Daystrom institute found that on average, 40% of mind meld participants survive the severing of a mind meld with no permanent brain damage<br />
**Ishemok:** Rule 234:  It's always speculation time.<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Do not forget Rule of Acquisition number 62: The riskier the road, the greater the profit<br />
<font color="#005500">GM: oh, AFK one sec, toddler</font><br />
![](../images/zox.png)**Zox:** Did they find any categorical enrichment of that 40% of symptomless surviors? Genetic markers or diet or drugs or something? What can we do to improve the odds, Lt. Cmdr?<br />
**Kurij:** I've got a focus in genetics and viral treatments, so if it helps I can review some of the documents<br />
**Zox: [ INSIGHT  (8) +  MEDICINE  (1)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 19]**<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** One interesting case study looked at 3 different mind melds in which all of the participants survived with no ill effects from the mind meld. The commonality was that the mind meld was severed by the performer having a siezure<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** It seems the Vulcan mind may have some kind of safety valve that severs the mind meld on its own in such cases<br />
**Kurij:** So what you're saying is we taze J'Davir<br />
![](../images/zerra.png)**Dr. Zerra:** Whatever you decide Commander Skig, do it quickly. We're losing them<br />
**J'Davir: [ FITNESS  (9) +  COMMAND  (1)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 16]**<br />
**Hailey Murry: [ FITNESS  (7) +  COMMAND  (1)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 17]**<br />
![](../images/zox.png)**Zox:** Skig, should we administer anathesia on them?<br />
>Elin begins convulsing more severely and blood begins to pour from her ears<br />

![](../images/zerra.png)**Dr. Zerra:** They are already unconscious<br />
![](../images/skig.png)**Skig:** Dr Zerra, as I understand it, the Vulcan mantra is the good of the many outweighs the good of the one. At this point, if it makes sense medically for use to induce some sort of Vulcan safety valve to break the mindmeld, I think it would meet with his approval.<br />
![](../images/skig.png)**Skig:** Therefore, if inducing a seizure in J'Davir will break the mindmeld as safely as the Twins believe possible, then do so.<br />
**Kurij:** It's not lethal for him, is it? <br />
![](../images/skig.png)**Skig:** Zox, can you help make sure his is restained, as Vulcans can demonstrate incredible strength in times of duress, or Pohn-Fahr.<br />
**Zox: [ FITNESS  (9) +  SECURITY  (4)]
[Focus: Endurance ]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 31]**<br />
*Zox follows Skig's orders unquestioningly.*<br />
![](../images/zerra.png)**Dr. Zerra:** I don't want to risk any crazy drug reactions or side effects, using a laser scalpel to manually burst a blood vessel in his brain is probably the safest option<br />
![](../images/zerra.png)**Dr. Zerra:** I just have to make sure to repair the damage again before he dies of an aneurism<br />
*Zox makes a 'womp womp' noise with his dino-horn.*<br />
![](../images/zerra.png)**Dr. Zerra:** Wait, does this violate my hypocratic oath?<br />
*Dr. Zerra pauses to consider whether intentionally giving someone a brain hemorrage violates his oath to do no harm*<br />
**Kurij:** No moreso than using a scalpal, would it? <br />
**Ishemok:** Hypocrticial oaths are much more proftiable.<br />
*Dr. Zerra looks like he is having doubts about the wisdom of this plan and will need to be convinced*<br />
**Ishemok:** Look, what you need is the brand-new, all points refined, precision laser scalpel from Mattel.<br />
**Ishemok: [ CONTROL  (9) +  COMMAND  (4)]
[Successes: 3] [Complications: 0]
Success with 2 momentum [2d20 = 5]**<br />
**Ishemok:** Starfleet already has provided one of these, cost-free!<br />
**Ishemok:** Who's gonna write up an article about this, and clean up on citations, and maybe score a commision from the manufacturer? One Dr. Zerra, that's who!<br />
![](../images/zerra.png)**Dr. Zerra:** And it is precise enough to accurately sever a single blood vessel in dense Vulcan brain matter without risk of permanent damage to other blood vessels?<br />
**Ishemok:** Look at all these smiling faces on the brochure? Aren't you convinced yet?<br />
![](../images/zerra.png)**Dr. Zerra:** I suppose it isn't "doing harm" per se if the instrument is so sophisticated as to eliminate the risk <br />
...
![](../images/skig.png)**Skig:** That is what I feel about my trusty hydrospanner, Doctor. Just give them a good whack.<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** I don't think giving J'Davir a whack would induce a siezure<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Unless the whack was extremely hard<br />
![](../images/zox.png)**Zox:** Aye that's our Skig?! What is a brain but a degenerate, glucose powered computer?<br />
![](../images/zerra.png)**Dr. Zerra:** Ok, Zox hold him down<br />
**Zox: [ DARING  (11) +  SECURITY  (4)]
[Focus: Endurance ]
[Successes: 1] [Complications: 1]
Success with 0 momentum [2d20 = 27]**<br />
![](../images/zerra.png)**Dr. Zerra:** Ok, here goes...<br />
*Dr. Zerra carefully severs a single blood vessel in J'Davir's anteocortex then steps back, but no siezure happens*<br />
**J'Davir: [ FITNESS  (9) +  MEDICINE  (2)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 21]**<br />
![](../images/zerra.png)**Dr. Zerra:** I don't understand, that should have had an immediate effect<br />
**Kurij ** *(muttering)*: That's the last thing you want your doctor to be saying<br />
![](../images/zerra.png)**Dr. Zerra:** Should we try a second one?<br />
![](../images/zox.png)**Zox:** Skig! We need a subspace scalpel! This one is only good for normal space!<br />
**Kurij: [ INSIGHT  (10) +  MEDICINE  (1)]
[Focus: Genetics ]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 22]**<br />
**Kurij:** Dr Zerra, is this medical protocol? <br />
*Kurij points to Zox's knee, which is currently on J'Davir's neck*<br />
**Kurij:** I don't think any blood is getting to the brain right now<br />
![](../images/zerra.png)**Dr. Zerra:** Ah, that explains it. He must be blocking the blood circulation<br />
![](../images/zerra.png)**Dr. Zerra:** I guess old habits die hard among security officers<br />
**Ishemok:** Um...Err....<br />
![](../images/zox.png)**Zox:** Oh....Whoops.<br />
![](../images/skig.png)**Skig:** I thought that was standard practice.<br />
*Skig shrugs.*<br />
>As soon as Zox lifts his knee from J'Davir's neck, he begins to violetly sieze<br />

**J'Davir: [ INSIGHT  (10) +  MEDICINE  (2)]
[Focus: Radiobiology ]
[Successes: 4] [Complications: 1]
Success with 3 momentum [4d20 = 32]**<br />
![](../images/skig.png)**Skig:** Ah yes, it would seem your plan was successful now that blood is flowing back to J'Davir's brain.<br />
![](../images/skig.png)**Skig:** Well done, Dr. Zerra.<br />
**Kurij:  [d6 = 3]**<br />
...
![](../images/zerra.png)**Dr. Zerra:** Not good<br />
![](../images/skig.png)**Skig:** Doctor, I believe you need to switch that from "cut" to "seal"<br />
![](../images/zox.png)**Zox:** Can we use stasis fields until we have a grasp on the situation?<br />
![](../images/zerra.png)**Dr. Zerra:** Zox, if you still have those illegal narcotics I need you to give the most powerful stimulant you can find to Nurse Kolea<br />
>frantically begins trying to save Elin and J'Davir<br />

![](../images/zerra.png)**Dr. Zerra:** frantically begins trying to save Elin and J'Davir<br />
...
![](../images/zerra.png)**Dr. Zerra:** Where did you send them?<br />
![](../images/murry.png)**Hailey Murry:** Woah<br />
![](../images/murry.png)**Hailey Murry:** Where did I send who?<br />
![](../images/zerra.png)**Dr. Zerra:** Not you, we'll fill you in later<br />
![](../images/skig.png)**Skig:** I beamed them into a transporter buffer in their current state, so you can bring them back one at a time and handle the situation in a lower stress environment.<br />
![](../images/zerra.png)**Dr. Zerra:** Hmm, sensible. We should start with J'Davir, his condition is more stable<br />
![](../images/skig.png)**Skig:** Lt Cmdr Viraseti, what is the situation when the subspace string at this time?<br />
<font color="#005500">indarien (Skig): (with) not (when)</font><br />
![](../images/zox.png)**Zox:** Did you still want these narcotics?<br />
![](../images/zerra.png)**Dr. Zerra:** No, I will revive Kolea before we rematerialize Elin<br />
*Zox looks deflated.*<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** The string appears to still be drawing heavily from something<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** I can't get a fix on the other end while Elin is in the buffer<br />
![](../images/skig.png)**Skig:** Dr, I believe Panic is never the solution, and you seemed dangerously close to acting in a less than calm and collected manner following your accident of driving a laser scalpel into Lt Elin's head.<br />
**Kurij:** Oh no, please tell me it can't latch onto the Lister<br />
...
![](../images/skig.png)**Skig:** In that case, would I suggest Elin first as we need to isolate and disperse this subspace string?<br />
![](../images/zerra.png)**Dr. Zerra:** Aye sir<br />
![](../images/zerra.png)**Dr. Zerra:** Nurse Kolea, we have a patient with a massive brain bleed. We're going to need to perform an emergency surgery to repair the damage<br />
...
**Kolea:** I see, I will be happy to help you with whatever Zox has done to himself now.<br />
*Kolea notices Zox standing there.*<br />
**Kolea:** Oh...umm...who's the patient?<br />
**Ishemok:** Hello Kolea!<br />
![](../images/zerra.png)**Dr. Zerra:** A Bolian, currently in the transporter buffer<br />
![](../images/zerra.png)**Dr. Zerra:** Skig, whenever you're ready<br />
*Dr. Zerra takes up position at the surgery bay with Nurse Kolea*<br />
![](../images/skig.png)**Skig:** Ready to bring her back to the operating table. Energizing in 3...2...1...<br />
**Kolea:** Doctor, that looks like a scar from a Mattel Starfleet Series 187 laser scalpel set to maximum power on a narrow band. Isn't that considered unsafe operation when the charge value is above 1.2 in these lighting conditions?<br />
**Hailey Murry: [ INSIGHT  (12) +  CONN  (3)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 15]**<br />
**Kolea:** I assume you were letting Zox touch things in my absense?<br />
![](../images/zerra.png)**Dr. Zerra:** Explain that to Lt. Kurij<br />
*Dr. Zerra gives Kurij a glare*<br />
**Kolea:** Oh, that would have been my third guess, sorry Ishemok.<br />
**Kolea: [ DARING  (9) +  MEDICINE  (4)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [d20 = 7]**<br />
![](../images/murry.png)**Hailey Murry:** That's...weird. Doctor, what are the odds of memories being transplanted during a mind meld?<br />
![](../images/skig.png)**Skig:** Doctor, you and Nurse Kolea seem to be performing miracles over there. Well done.<br />
**Skig: [ CONTROL  (11) +  ENGINEERING  (5)]
[Focus: Emergency Repairs ]
[Successes: 4] [Complications: 0]
...
![](../images/skig.png)**Skig:** Hailey, perhaps the Twins would have a good idea about that?<br />
![](../images/murry.png)**Hailey Murry:** Ah, Twins, what do you--<br />
*Hailey Murry glances over at the Twins, who are in an unconscious heap in the corner*<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** It seems like a not uncommon occurance. The literature contains at least 1,561 incidences of memories being transferred during abnormal mind melds<br />
*Hailey Murry has to think for a moment to remember what happened earlier*<br />
![](../images/murry.png)**Hailey Murry:** Okay...okay...Well I suppose forward those over to my files please, I'll apparently need to review them later<br />
**Ishemok: [ INSIGHT  (9) +  SCIENCE  (2)]
[Focus: Philosophy ]
[Successes: 3] [Complications: 0]
Success with 2 momentum [2d20 = 11]**<br />
![](../images/zerra.png)**Dr. Zerra:** Should we move on to repairing J'Davir's aneurism now?<br />
![](../images/zerra.png)**Dr. Zerra:** Skig, at your convenience<br />
*Dr. Zerra stands ready at the surgery bay*<br />
**Ishemok:** Skig! I have an idea for you! A Torres Inhibitor might be just as effective at disspating this anomaly as it is in disrupting the Borg Hive-Mind; we can replicate it on site with the plans we already have!<br />
![](../images/skig.png)**Skig:** No problem doctor.<br />
**Ishemok:** I would love to help in this endeavor!<br />
![](../images/skig.png)**Skig:** But first, Lt Cmdr Viraseti, can you check on the subspace cosmic string and see what its status is now that Lt Elin and Counselor Murry are awake and coherent and no longer at risk of aneurysm and death?<br />
**Ishemok:** There are already 3,222,111 happy Borg that no longer hear the voices thanks to this miracle of science, the Torres Inhibitor! What further marvels will it reveal when repurposed by the Brilliant Engineer Skig? We just can't wait to find out: Energize one, Today!<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** It seems to have reached some kind of equilibrium state, it's no longer engorged and I am not readying any excess neurological energy. It is still attached to both Counselor Murry and Lt. Elin as far as I can see though<br />
![](../images/skig.png)**Skig:** Does it appear to present a threat to the Lister or any of the crew in its current state?<br />
![](../images/murry.png)**Hailey Murry:** An improvement, at least<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** It doesn't seem to be dangerous at the moment<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Any moreso than an ordinary subspace cosmic string<br />
![](../images/murry.png)**Hailey Murry:** Of course not, but we can actually take our time to fix it without worrying about the Captain sending another squad after us in the meantime<br />
![](../images/zox.png)**Zox:** Yes, but, it's just a matter of time before either you or Elin have some sort of emotional resonance and cause it to flare up again. Why, as your security officer I am skeptical of allowing you to drink heavily while it still remains.<br />
![](../images/zox.png)**Zox:** No more heavy intoxicants until you've solved your anomaly!<br />
**Zox: [ CONTROL  (11) +  COMMAND  (3)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 16]**<br />
![](../images/murry.png)**Hailey Murry:** I do not drink heavily, it's a controlled passtime<br />
![](../images/skig.png)**Skig:** I think we should heavily sedate the counselor for as long as she is a threat to the ship.<br />
![](../images/murry.png)**Hailey Murry:** As Viraseti just said, Skig, it doesn't seem to be dangerous at the moment.<br />
![](../images/skig.png)**Skig:** Doctor, I am satisfied the situation is resolved enough though that I will rematerialize J'Davir to the operating table. Energizing in 3...2...1...<br />
**Skig: [ CONTROL  (11) +  ENGINEERING  (5)]
[Focus: Computers ]
[Successes: 3] [Complications: 0]
Success with 2 momentum [2d20 = 9]**<br />
![](../images/murry.png)**Hailey Murry:** Apparently it's pretty common side effect of mind melds, or at least not uncommon<br />
*Hailey Murry glances over at Lt Elin, blinking in confusion*<br />
![](../images/skig.png)**Skig:** Counselor, I doubt the veracity of your intent, given the risks you have posed recently, but I shall take your suggestion under advisement.<br />
![](../images/murry.png)**Hailey Murry:** Twins, can you please look up the likelihood of gaining a telepathic link via a mind meld? <br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** There is no record of such an occurance in the medical literature<br />
**Kolea: [ DARING  (9) +  MEDICINE  (4)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [d20 = 3]**<br />
*Kolea sighs.*<br />
**Kolea:** All of her efforts are in vain, yet again.<br />
![](../images/skig.png)**Skig:** I think I just heard the Lister sigh.<br />
![](../images/skig.png)**Skig:** Twins, was that you?<br />
**J'Davir: [ FITNESS  (9) +  CONN  (4)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 25]**<br />
...
**Kolea:** Doctor, I'm not sure what combination of medicines you gave me, but we should definitely write this down and prepare it in some hyposprays for future use. I feel significantly better than I probably should.<br />
...
![](../images/zox.png)**Zox:** Okay...so things appear to be settling down?<br />
**J'Davir:** Thank you doctor, although, for the record, if you needed to break a mind-meld, a simple snifter of Romulan Dysneri Salts would have sufficed.<br />
![](../images/zerra.png)**Dr. Zerra:** I will note that in the Starfleet medical database<br />
**J'Davir:** And, I have a strange Voth-shaped bruise on my neck and a very nasty headache that is likely symptomatic of long term drain blammage. I'm sure it is nothing that cannot be resolved through the judicious application of referring to Vulcan scripture in the Book of Nimoy.<br />
**J'Davir:** I kind of like this guy, we should keep him around.<br />
**Ishemok:** How was that not there....wasn't Romulans the first species humans encountered? <br />
**Kolea:** I kind of like this guy, we should keep him around.<br />
*Kolea gestures to J'Davir and Ishemok.*<br />
*Hailey Murry fiddles around with a data pad*<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** That's odd, the string seems to be growing again<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** Perhaps we're not out of the woods yet<br />
*Ishemok sings a musical jingle about a Torres inhibitor.*<br />
*Hailey Murry sighs*<br />
**Ishemok: [ INSIGHT  (9) +  CONN  (3)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 17]**<br />
**Ishemok:** ...When subspace has got ya down, won't you be happy Torres is around...!<br />
**Kolea: [ INSIGHT  (11) +  COMMAND  (2)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 25]**<br />
![](../images/zox.png)**Zox:** Hailey needs sedatives now!<br />
![](../images/zerra.png)**Dr. Zerra:** What? Why?<br />
**Ishemok:** The anomaly is growing with her anger.<br />
![](../images/murry.png)**Hailey Murry:** Wait, why? <br />
**Kolea:** Counselor Murry, for the sake of the crew, I am ordering you as a medical practitioner that you are to lie on that bed, you will take appropriate sedative medications, and you will do nothing to convince Skig that throwing you out an airlock is a good idea.<br />
**Kolea: [ INSIGHT  (11) +  MEDICINE  (4)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 23]**<br />
...
![](../images/murry.png)**Hailey Murry:** Perhaps you should inquire with the patient about her state of being before you sedate her, Nurse Kolea? Because sometimes they can offer something insightful and explanatory<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** The string seems to be shrinking again<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** What in space is going on over there?<br />
**Kolea:** Nope, not in this case.<br />
![](../images/zox.png)**Zox:** But there's two or possibly three people that control it now.<br />
![](../images/zox.png)**Zox:** It must be destroyed.<br />
*Kolea readies stun tranquilizer.*<br />
![](../images/murry.png)**Hailey Murry:** What about "the bond is present and active even when the patients are unconscious"?<br />
![](../images/skig.png)**Skig:** Can we go back to that part about spacing people? I mean, if the string is attached to two people and they are not on the Lister, then the Lister would be safe, right?<br />
*Kolea pauses.*<br />
**Kolea:** Umm...Skig, I was kind of joking.<br />
![](../images/skig.png)**Skig:** Oh.<br />
![](../images/zox.png)**Zox:** Prepare a sack lunch and suit for anyone we have to space!<br />
**Kolea:** Murray has a point, I was just getting ahead of myself based on the fact that she has violently attacked me a couple times this episode, including randomly suplexing me in the hallway at the beginning of the episode.<br />
![](../images/zox.png)**Zox:** ...just in case of course. <br />
![](../images/bachar.png)**Cmdr Bachar:** Pretty sure all of that violates every single Starfleet regulation<br />
![](../images/murry.png)**Hailey Murry:** That was not random! You were approaching aggressively and on all fours! <br />
*Cmdr Bachar strides confidently into Sickbay, still carrying a phaser rifle*<br />
**Ishemok:** ....when you can't see a trace, it's time to dis---rupt subspace! (Continues song and dance advertising for the Torres Inhibitor)<br />
![](../images/bachar.png)**Cmdr Bachar:** The captain seemed to calm down a few minutes ago, but comms are still down so I couldn't call. Good thing I decided to check in<br />
![](../images/skig.png)**Skig:** Nonsense, it does not violate section 132, paragraph 8, where the good of the ship may necessitate stranding crew.<br />
<font color="#005500">BayushiKazemi (Hailey Murry): Focus: Disney Princess</font><br />
**Ishemok: [ CONTROL  (9) +  COMMAND  (4)]
[Focus: Salesmanship ]
[Successes: 3] [Complications: 0]
Success with 2 momentum [2d20 = 13]**<br />
![](../images/skig.png)**Skig:** I mean, sections 14-32 would indicate spacing of crew is generally frowned on.<br />
![](../images/skig.png)**Skig:** However, other alternatives need to be evaluated first.<br />
*Cmdr Bachar narrows her eyes at Skig*<br />
![](../images/bachar.png)**Cmdr Bachar:** I should think so<br />
**Ishemok:** when those borg have got'ya down, turn the situation right around!<br />
![](../images/murry.png)**Hailey Murry:** Thank you, Bachar. How's the bridge? <br />
**Kolea:** Yes, yes indeed. Let's just shoot right past this part of the conversation. Murry, you were going to offer something insightful prior to being sedated?<br />
![](../images/bachar.png)**Cmdr Bachar:** Situation normal, the Captain is no longer screaming about killing Zox <br />
![](../images/bachar.png)**Cmdr Bachar:** Although he's going to have a bit of a headache for a day or two from the wide beam stun<br />
![](../images/zox.png)**Zox:** Will you STOP that jingle? I'll energize the damn thing already!<br />
![](../images/skig.png)**Skig:** Ishemok's suggestion of a Torres Inhibitor as a way to see if that offsets the connection between the cosmic string.<br />
![](../images/skig.png)**Skig:** We can try that route while Zox's prepares some EVA suits, you know, just in case.<br />
**Ishemok: [ FITNESS  (9) +  CONN  (3)]
[Focus: Klingon calisthenics ]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 21]**<br />
![](../images/bachar.png)**Cmdr Bachar:** Belay that Zox, no EVA suits<br />
![](../images/skig.png)**Skig:** Good call, that would save on having to restock them, I like your forward thinking approach, Commander.<br />
![](../images/murry.png)**Hailey Murry:** Fantastic. We've deflated the subspace cosmic string so it's not interfering with anything anymore, Lt Elin and I are both calming down. We're apparently connected with some sort of telepathic bond, though. Memories and some vocaliazation and sensory crossing<br />
![](../images/bachar.png)**Cmdr Bachar:** Skig, replicate this inhibitor that the Ferengi won't stop singing about<br />
**J'Davir:** That was likely a side effect of having the mind-meld broken violently. My apologies<br />
*Skig brings up the standard template for a Torres Inhibitor and creates one in Sick Bay.*<br />
**Ishemok:** We've got to save our crew, no no doctor this won't do, the emotions they all brew, if we don't a patient is gonna sue!<br />
![](../images/bachar.png)**Cmdr Bachar:** Any risks with this thing we need to know about?<br />
**Ishemok:** Nope.<br />
![](../images/zox.png)**Zox:** Nope!<br />
*Skig checks the user manual.*<br />
**Ishemok: [ INSIGHT  (9) +  SCIENCE  (2)]
[Successes: 0] [Complications: 1]
Failed on DC: 1 [2d20 = 34]**<br />
![](../images/skig.png)**Skig:** Side effects include a strong desire to shoot the nearest Ferengi and space the ship's counselor.<br />
![](../images/murry.png)**Hailey Murry:** Dr Zerra, how is Lt Elin? <br />
![](../images/skig.png)**Skig:** Seems totally acceptable.<br />
*Kolea takes the instruction manual from Skig.*<br />
![](../images/murry.png)**Hailey Murry:** Oh my gosh I wonder if this is what it's like for the Twins<br />
**Kolea:** You are insufferable!<br />
*Kolea looks at Murry.*<br />
![](../images/zerra.png)**Dr. Zerra:** Condition stable, though it might be a few hours before she regains consciousness. She's been through a lot<br />
![](../images/bachar.png)**Cmdr Bachar:** Ok, if we're satisfied there's no risk then lets do it<br />
**Kolea:** Sorry for channeling my inner Skig there earlier, I shall endeavor to not suggest sedating you prior to letting you get a word in next time.<br />
![](../images/zox.png)**Zox:** ....but if we put Elin and Murray in different ships, and clothesline the enemy ship between them, we will disable them without firing a shot!<br />
**J'Davir:** This crew apology session warms the cockles of my cold Vulcan heart.<br />
![](../images/zox.png)**Zox:** Oh sorry. I shouldn't be tryign to weaponize this anomaly....<br />
![](../images/skig.png)**Skig:** Zox, no. Don't even go there.<br />
![](../images/zox.png)**Zox:** but but but...<br />
![](../images/zox.png)**Zox:** Clothesline Finisher!<br />
![](../images/skig.png)**Skig:** Stop silly Dinosaur.<br />
**Kolea:** Zox, I do not think you should consider option.<br />
**Zox: [ DARING  (11) +  ENGINEERING  (4)]
[Focus: Espionage ]
[Successes: 4] [Complications: 0]
...
![](../images/murry.png)**Hailey Murry:** Well, that was odd<br />
![](../images/bachar.png)**Cmdr Bachar:** Did anything happen?<br />
![](../images/bachar.png)**Cmdr Bachar:** Or did Zox break it<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** I no longer have the string on sensors<br />
![](../images/murry.png)**Hailey Murry:** I don't have her voice in my head anymore<br />
![](../images/murry.png)**Hailey Murry:** But I...some of the memories are still there<br />
![](../images/murry.png)**Hailey Murry:** I'm going to need some time to sort through this<br />
**Ishemok:** When at first we had no clue, all of us were feelin blue; when we got to inhibition, we had fixed our coooooognition!<br />
![](../images/skig.png)**Skig:** I recommend we move out of the area, turn the Inhibitor off and see if Counselor Murry and Lt. Elin are no longer connected. We likely do not want to run a Torres Inhibitor at all times as it could interfere with other ship systems.<br />
**Zox: [ FITNESS  (9) +  SECURITY  (4)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 24]**<br />
![](../images/bachar.png)**Cmdr Bachar:** Ensign if you don't stop singing, spacing will be back on the table<br />
*Kolea looks up from the user manual.*<br />
>♫♫♫Lighthearted Music Sting♫♫♫<br />

>---------CUT TO COMMERCIAL-------<br />

**Kolea:** I agree with Skig that we do not want to run this all the time.<br />
...
![](../images/skig.png)**Skig ** *(mutters under her breath)*: Oh sure, the Commander can suggest spacing people who annoy her, but spacing people to protect the Lister is bad. I see how it is.<br />
<font color="#005500">Masakari (Zox): my dice have caused enough harm for one episode...</font><br />
![](../images/malat.png)**Lt. Malat:** Sounds like I missed a pretty wild time in sickbay<br />
![](../images/zox.png)**Zox:** I still do not understand all this sutblety in communications Skig. It baffles me.<br />
![](../images/skig.png)**Skig:** Nurse Kolea and Dr Zerra performed admirably saving the lives of Lt. Elin and J'Davir.<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** I was impressed with Ensgin Ishemok, I've already put in for him to be transferred to my department<br />
![](../images/viraseti.png)**Lt. Cmdr Viraseti:** I think if he can learn to stop trying to rob everyone all the time, he could grow into a valuable officer<br />
![](../images/skig.png)**Skig:** He does seem better suited to work in your division than to be third shift left nacelle supervisor.<br />
**Ishemok:** I swear off petty theft forever! For the Federation!<br />
![](../images/skig.png)**Skig:** To be fair, he had that role because the spinning dart board picked it for him.<br />
![](../images/bachar.png)**Cmdr Bachar:** I'll approve the personel transfer whenever my command codes are reactivated, it seems the captain locked me out for "leading a mutiny" at some point before we resolved the situation<br />
![](../images/skig.png)**Skig:** I should probably reinstate you and Zox. I think I have that in my To-Do list for tomorrow.<br />
*Skig checks her datapad.*<br />
![](../images/skig.png)**Skig:** Yep.<br />
![](../images/zox.png)**Zox:** but If I am not an officer, then I do not need to obey the officer code of conduct?<br />
*Captain Baras enters the lounge and picks up a drink, then heads over towards the senior staff*<br />
![](../images/murry.png)**Hailey Murry:** No, but you still have to obey the more restrictive Redshirt Code of Conduct<br />
![](../images/skig.png)**Skig:** Per Starfleet Code, you are suspended but still an officer, section 19, paragraph 7 Zox.<br />
![](../images/murry.png)**Hailey Murry:** Hello, Captain. Did you have a good mutiny? <br />
*Hailey Murry offers a toast to him*<br />
![](../images/baras.png)**Captain Baras:** Skig, I'm going to have to leave in command for a couple of days. Dr. Zerra relieved me of duty for 48 hours while I recover<br />
![](../images/zox.png)**Zox:** Hailey, why does your species not merely headbutt each other till all transgressions are forgotten or forgiven?<br />
*Captain Baras accepts Murry's toast*<br />
![](../images/baras.png)**Captain Baras:** Just a headache at this point, nothing too bad<br />
![](../images/murry.png)**Hailey Murry:** That's pretty common behavior among the males, but typically it's frowned upon. It's preferred to talk things out<br />
![](../images/skig.png)**Skig:** I understand Captain, I hope you are able to recover. I am sure Nurse Kolea could offer some relaxation routines to help you recover.<br />
*Skig is completely baffled by all the snickering and laughs by 2/3 of the people when she states that.*<br />
![](../images/murry.png)**Hailey Murry:** How's Lt. Elin? <br />
![](../images/baras.png)**Captain Baras:** I'm sure things will be back to normal in a couple of days, just don't do anything too crazy. I can't leave Bachar in command, she's still under an arrest order for leading the mutiny<br />
*Captain Baras chuckles as he walks off*<br />
![](../images/skig.png)**Skig:** Oh, so... I should...<br />
*Skig looks at datapad.*<br />
![](../images/skig.png)**Skig:** Hmm.... the old man is good, he just deleted that section of my to-do list.<br />
*Skig has newfound respect for Captain Baras' hacking skills.*<br />
![](../images/malat.png)**Lt. Malat:** I don't think he actually meant for you to arrest the commander<br />
![](../images/skig.png)**Skig:** Nonsense, according to this, I need to reinstate Zox so he can arrest Lt Malat and Commander Bachar. Seems totally plausible as an outcome.<br />
*Zox eats some plant decor and enjoys the serenity.*<br />
![](../images/bachar.png)**Cmdr Bachar:** You can't be serious<br />
*Zox glances over, realizing that Skig can _only_ be serious.*<br />
*Zox continues grazing.*<br />
![](../images/skig.png)**Skig:** Is there some other method of operation I should try, Commander?<br />
![](../images/bachar.png)**Cmdr Bachar:** You can try comprehending the existence of a joke<br />
![](../images/skig.png)**Skig:** Ah, I shall give that a thought. Very well, I guess I can postpone this arrest order until after closing time at the bar, try not to start any fights.<br />
![](../images/bachar.png)**Cmdr Bachar:** You piece of...<br />
>♫♫♫Lighthearted Music Sting♫♫♫<br />
