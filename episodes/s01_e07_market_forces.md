...
![](../images/zox.png)**Zox:** I am glad to see you doing much better.<br />
...
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** We were hoping you could help<br />
...
![](../images/murry.png)**Hailey Murry:** Why is there an anti-union organizing person here? Ishemok, is that a sport in Ferengi space? <br />
...
![](../images/skig.png)**Skig:** Github broke and lost track.<br />
...
![](../images/zox.png)**Zox:** Hello Malat. Was what happend at Empok Nor as spicy as those wings?<br />
...
![](../images/skig.png)**Skig:** I agree with Malat, spreadsheets are only exciting when they involve recalulating flow rates and supply ledgers for engineering.<br />
...
![](../images/malat.png)**Lt. Malat:** This place is boring, I'm up for it<br />
*Throk looks at Malat.*<br />
...
*Lt. Malat scoffs*<br />
![](../images/skig.png)**Skig:** My ships only fall apart when they come in contact with clumsy crew members!<br />
...
![](../images/malat.png)**Lt. Malat:** Zox is right, we need a cover before we go poking around<br />
...
![](../images/malat.png)**Lt. Malat:** What department are you even in? Who is your SO that I can file a complaint with?<br />
...
![](../images/malat.png)**Lt. Malat:** Now I'm no Parrisses Squares team manager, but that sounds like some money laundering shit to me<br />
...
![](../images/skig.png)**Skig:** I'd rather not take the Lister near a secret enemy space station.<br />
...
![](../images/skig.png)**Skig:** It's not my fault the XO doesn't want to review line item manifests for individual bolt components as part of the refit.<br />
...
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** In light of the Commander's surveilance, we have established a local area neural network for us to continue this conversation<br />
...
![](../images/skig.png)**Skig:** Also, given some of our recent assignments, I doubt the Lister is getting randomly generated "go do something missions", there are ulterior motives at play. <br />
*Skig winks at GM.*<br />
...
![](../images/skig.png)**Skig:** This is also why he was transferred to security, as use of Vogon Poetry is considered an interrogation technique so heinous, even the Dominion banned it.<br />
...
![](../images/malat.png)**Lt. Malat:** Wait didn't Kolea request a bereavement leave to notify J'Davir's parents of his death?<br />
...
![](../images/skig.png)**Skig:** Yes, what Malat said.<br />
...
![](../images/zox.png)**Zox:** Hailey, do something!<br />
...
**Kolea:** I don't have authorization, you will need Dr. Zerra to submit to Starfleet that you are still alive.<br />
...
![](../images/malat.png)**Lt. Malat:** I doubt he gets a lot of fans visiting<br />
...
![](../images/murry.png)**Hailey Murry:** WATCH FOR THE RICOCHET!<br />
...
![](../images/zox.png)**Zox:** Wow I feel like i could take a boulder to the chest and not flinch.<br />
...
**Jasanis:** We told you we'd be watching<br />
...
![](../images/zox.png)**Zox:** Yeah, I mean, other than comandeering a shuttle and going to Empok Nor, I am fresh out of ideas. <br />
...
![](../images/zox.png)**Zox:** Were on our best behavior here.<br />
...
![](../images/malat.png)**Lt. Malat:** We need a ship<br />
...
![](../images/murry.png)**Hailey Murry:** I can promise you can at least punch her, but we'll have to talk more about it when the time comes<br />
...
![](../images/zox.png)**Zox:** Yeah, you don't feel you can stay clean without a steady supply of lava soap. I understand.<br />
...
**Ishemok:** Okay team, that gets us past obstacle one. Do we have a cover story for when we land at station up to, oh, probably all the forms of no-goodery in the universe?<br />
...
![](../images/zox.png)**Zox:** Could you tell us more about this?<br />
...
![](../images/malat.png)**Lt. Malat:** We could try, if you've got something in mind<br />
...
![](../images/murry.png)**Hailey Murry:** Hello, would you like something to drink? <br />
...
![](../images/malat.png)**Lt. Malat:** Jasanis already knows we're onto her, if we detour all the way back she'll be long gone<br />
...
![](../images/zox.png)**Zox:** Sizzlin Sauce<br />
...
![](../images/zox.png)**Zox:** We are only there to sample and set up a contract<br />
...
![](../images/zox.png)**Zox:** You can just smell the crime that's here.<br />
...
![](../images/zox.png)**Zox:** GalaxyGourmet<br />
...
![](../images/zox.png)**Zox:** Salty! Can jou look over zis pap'er? <br />
...
**Throk:** Throk was wondering what exchange rate between Ferengi Organs per days of storage are.<br />
...
**Throk:** They have good bondage outfits in this issue, make for great BBQ ideas.<br />
...
![](../images/murry.png)**Hailey Murry:** Wait...where did Zox get warpaint from? I thought he only had hot sauce<br />
...
![](../images/murry.png)**Hailey Murry:** Thank you, Throk, the teamwork continues to be appreciated<br />
...
**Jasanis:** I have to say I'm dissapointed girl scout, I thought you would be more of a problem. I didn't even know you were on board and then my people tell me you're captured? Dissapointing...<br />
...
**Throk:** Throk understand many Orion men like "watching" but first he has heard of women being the same way.<br />
...
![](../images/skig.png)**Skig:** You didn't take Old Faithless out for a spin, did you?<br />
...
[Successes: 3] [Complications: 0]
Success with 2 momentum [2d20 = 10]**<br />
![](../images/bachar.png)**Cmdr Bachar:** As close as you can get me to Ops<br />
...
![](../images/skig.png)**Skig:** And we might need the disruptor power supply later, but for now, just shoulder it.<br />
...
![](../images/skig.png)**Skig:** See you soon Sweetheart, give my love to the kids.<br />
...
[Successes: 0] [Complications: 1]
Failed on DC: 1 [2d20 = 38]**<br />
![](../images/zox.png)**Zox:** I don't understand these goofy shields!<br />
>[TURN] Zox<br />

**Skig: [ INSIGHT  (8) +  CONN  (2)]
[Successes: 0] [Complications: 0]
Failed on DC: 1 [2d20 = 36]**<br />
![](../images/murry.png)**Hailey Murry:** I hope you understand them better than we did last time<br />
![](../images/skig.png)**Skig:** Kosal, since you have just become a pilot, I need you to bring us around to heading 174 mark 6, accelerate to 0.7 and fly towards that outstretched pylon. Bachar will be heading towards the lower quadrant animal processing zone.<br />
...
![](../images/zox.png)**Zox:** Those smarmy Taganites messed with the wrong Chef! Muhauahaha<br />
...
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** What is your plan ma'am? We would suggest that we should vacate this area quickly<br />
**T'Kor: [ CONTROL  (11) +  ENGINEERING  (4)]
[Focus: Repair/Tinkering ]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 26]**<br />
...
**Ishemok:** I think I just qued up a pretty good defensive put. <br />
![](../images/skig.png)**Skig:** We get Bachar and Malat and get out of here. We either need the Transporters back online or we are going to just plow through that mass of ships milling about near the meat processing plant and make a parking spot, like what you did earlier.<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Aye ma'am<br />
>[TURN] Hailey Murry<br />

**Hailey Murry: [ CONTROL  (8) +  ENGINEERING  (2)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 11]**<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** We are reading an unshielded cargo area near the rendezvous point, if you are unable to repair the transporters we could attempt an emergency landing/ Although we would advise against it, given the incoming fire<br />
![](../images/skig.png)**Skig:** Lt Cmdrs, sometimes we need any port in a storm.<br />
**Throk:** Throk not sure what to do. Everyone so heroic.<br />
**Throk:** Throk recite epic Gorn battle poem to create morale advantage over woeful inferior foes.<br />
**Throk: [ INSIGHT  (9) +  COMMAND  (2)]
[Focus: Poetry ]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 17]**<br />
*Zox raises his new tritanium plated spatula to the heavens in appreciation of the poem.*<br />
**Throk:** MIGHTY GORN WARRIOR SMASH ROCK PEOPLE WITH THICK MEATY HAMMER!<br />
>[TURN] Throk<br />
...
![](../images/skig.png)**Skig:** OH GREAT WARBLE OF GORN WAR WOOTLES OF DESTRUCTION!<br />
**Throk:** OH GREAT WARBLE OF GORN WAR WOOTLES OF DESTRUCTION!<br />
...
**Zox:  [Total: 3] [Effects: 1] [2dChallenge = 3]**<br />
![](../images/zox.png)**Zox:** I hope you are ready for some GALATIC Parrises' Squares, Sir Kosal!<br />
...
![](../images/zox.png)**Zox:** Full Contact Sport!<br />
**Hailey Murry: [ INSIGHT  (12) +  ENGINEERING  (2)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 19]**<br />
>[TURN] Hailey Murry<br />
...
![](../images/zox.png)**Zox:** Get em up here! They are missing all the fun!<br />
**Throk:** Why does transport screen show only bloody spaghettti noodles as valid targets?<br />
>[INITIATIVE] Hostile forces have the initiative!<br />

**Ishemok:** Are you looking at the cafe menu options?<br />
![](../images/murry.png)**Hailey Murry:** It looks like the Syndicate's most important transports are already clear and well out of the way out of the system. I'll see if I can break through the encryption on the more detailed transmissions<br />
**Ishemok:** I should already have lots of Data, Hailey. <br />
>[INITIATIVE] Allied forces have the initiative!<br />

**Ishemok:** We ought to have enough for a complete investigation, provided we survive.<br />
...
![](../images/skig.png)**Skig:** Ishemok and the Twins, locate Bachar and Malat so we can beam them over.<br />
<font color="#005500">BayushiKazemi (T'Kor): "it's a difficulty zero", he says</font><br />
![](../images/skig.png)**Skig:** Kosal, continue to swing us closer to the unshielded area.<br />
![](../images/skig.png)**Skig:** Throk...umm...do whatever it is you are doing, I guess.<br />
**Ishemok:** I've got em! Coordinates are being uploaded directly to your console, T'kor!<br />
*Ishemok: Beep Boop Beep*<br />
...
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** We have the coordinates. Energizing...<br />
...
**Throk:** Throk think Transporter not 100% successful here.<br />
*Cmdr Bachar looks around, then tosses the disruptor rifle to the ground*<br />
**Ishemok:** How went things?<br />
![](../images/zox.png)**Zox:** We all back and together?<br />
![](../images/bachar.png)**Cmdr Bachar:** Skig, did you forget that we came here in an armed Miradorn raider?<br />
![](../images/bachar.png)**Cmdr Bachar:** Get Zox over there, we need some actual cover<br />
![](../images/zox.png)**Zox:** But...but...We are playing Parrises squares for our honored guest!<br />
>[INITIATIVE] Hostile forces have the initiative!<br />

![](../images/zox.png)**Zox:** It's only a few more moments till we score!<br />
![](../images/skig.png)**Skig:** Yes, all part of the plan, Commander.<br />
...
Failed on DC: 1 [2d20 = 38]**<br />
**Ishemok:** Bawwwww<br />
![](../images/skig.png)**Skig:** Murry, get Ishemok out of the security system. T'Kor and the Twins, mass transport everyone over to the Miradorn Freighter, here are the shield harmonic codes to get past the shielding array/<br />
>[INITIATIVE] Hostile forces have the initiative!<br />

**T'Kor: [ CONTROL  (11) +  ENGINEERING  (4)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 17]**<br />
![](../images/skig.png)**Skig:** Throk, get Malat some medical attention.<br />
>[TURN] Hailey Murry<br />

**T'Kor:** Their ships won't be able to report anything for a while, I've got them jammed<br />
![](../images/bachar.png)**Cmdr Bachar:** Stand-by, Zox overload the tractor emitters at high frequency. It should flood their sensors so they can't read the confinement beam<br />
...
![](../images/bachar.png)**Cmdr Bachar:** Get us out of here<br />
![](../images/bachar.png)**Cmdr Bachar:** Before they catch on<br />
![](../images/skig.png)**Skig:** Kosal, set course 117, maximum warp for 35 minutes, then drop to impulse and set course 149, warp 5 for 10 minutes, then source 218.8 at warp 6 to get us back to Bajor so we can drop you off.<br />
**Ishemok: [ DARING  (10) +  SECURITY  (2)]
[Focus: Computers ]
[Successes: 3] [Complications: 0]
Success with 2 momentum [2d20 = 13]**<br />
...
**Throk:** She is dead.<br />
![](../images/bachar.png)**Cmdr Bachar:** Murry, take over from Throk<br />
![](../images/bachar.png)**Cmdr Bachar:** Before he amputates any of her limbs<br />
*Ishemok energizes a copy of 'operation' for Throk.*<br />
![](../images/skig.png)**Skig:** Throk not amputate, Throk not have chainsaw.<br />
**Hailey Murry: [ DARING  (11) +  MEDICINE  (3)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 22]**<br />
**Throk:** Throk not amputate, Throk not have chainsaw.<br />
![](../images/murry.png)**Hailey Murry:** No eating injured comrades<br />
>Murry is able to stablize Malat before Throk cooks her into a pie<br />

*Hailey Murry does a proper checkup on Malat*<br />
![](../images/bachar.png)**Cmdr Bachar:** When we get back to the Lister, you tell Dr. Zerra that you were injured playing Parisses squares<br />
**Throk:** Throk not allowed to eat other Starfleet officers. Specifically listed as top bullet point of agreement with mighty Gorn Hegemony.<br />
![](../images/bachar.png)**Cmdr Bachar:** And no one files a report<br />
![](../images/bachar.png)**Cmdr Bachar:** This op is strictly off-the-books<br />
![](../images/murry.png)**Hailey Murry:** Yes ma'am<br />
**T'Kor:** I don't even know how to file a report<br />
*Skig shrugs.*<br />
![](../images/bachar.png)**Cmdr Bachar:** Murry, fix that when we get back<br />
![](../images/murry.png)**Hailey Murry:** Will do!<br />
![](../images/bachar.png)**Cmdr Bachar:** We can't have an incorrectly deceased crewmember on the engineering staff<br />
**Ishemok:** Why not? It really helps to have in non-existent situations like this.<br />
![](../images/bachar.png)**Cmdr Bachar:** It's exploitative and immoral<br />
![](../images/bachar.png)**Cmdr Bachar:** That's why not. Ensign.<br />
**Ishemok:** Keep going...<br />
...
![](../images/zox.png)**Zox:** Jasanis is still out there.<br />
![](../images/skig.png)**Skig:** Yes, and you are all still alive.<br />
![](../images/murry.png)**Hailey Murry:** And we picked out quite a lot of data from the space station. From her own admission, we cost her a lot<br />
![](../images/skig.png)**Skig:** It would be very sad to have to tell Captain Baras that several of his command crew died gruesomely on an Orion Syndicate station after he forbade your departure from the station we were in.<br />
*Zox blinks.*<br />
![](../images/bachar.png)**Cmdr Bachar:** It would have been hard to explain, but I hoped you would manage<br />
![](../images/zox.png)**Zox:** Have you understood sad now?<br />
*Zox lets out a melancholy dirge-wootle.*<br />
![](../images/bachar.png)**Cmdr Bachar:** We're going to have a lot of intel to go through when we get back. But I want to be clear: nothing goes on the main computer, keep on non-networked padds. Nothing goes in a report, and you don't discuss it without first sweeping for bugs<br />
**Throk:** Throk understand sadness. It happen when he get large piece of gristle caught between rear incisors and have to use power wash to get it out. Quite panful.<br />
![](../images/bachar.png)**Cmdr Bachar:** You aren't the group I would have hand-picked to bring in on this, but you have to take opportunities as they come<br />
*Skig looks at Zox.*<br />
![](../images/zox.png)**Zox:** So....about those bugs?<br />
![](../images/murry.png)**Hailey Murry:** Always glad to give the opportunities<br />
![](../images/bachar.png)**Cmdr Bachar:** When you approached me on the station, I couldn't talk. There was no way to properly sweep for bugs in the station lounge<br />
![](../images/bachar.png)**Cmdr Bachar:** I knew if I shot you down you wouldn't be willing to let it go<br />
![](../images/zox.png)**Zox:** Interesting.<br />
![](../images/bachar.png)**Cmdr Bachar:** But let's be clear about something for the future<br />
![](../images/bachar.png)**Commander Bachar:** If you ever think you are pulling one over on me, you are wildly mistaken. I am in every room, on every wall. I am every sound you hear, and every shadow you see. I know everything that happens on my ship, and under my command. And do not think for one second that I do not know what you are up to.<br />
![](../images/bachar.png)**Cmdr Bachar:** If you ever think you are pulling one over on me, you are wildly mistaken. I am in every room, on every wall. I am every sound you hear, and every shadow you see. I know everything that happens on my ship, and under my command. And do not think for one second that I do not know what you are up to.<br />
*Skig shrugs.*<br />
**Zox: [ INSIGHT  (8) +  ENGINEERING  (4)]
[Focus: Espionage ]
[Successes: 1] [Complications: 1]
...
**Throk:** Throk wonder if Mighty XO need therapy from knowing everything Kolea is doing on ship.<br />
![](../images/bachar.png)**Cmdr Bachar:** Kolea is mostly harmless<br />
**Throk:** Also, Throk forgot to pick up 10,000 gallons of anti-viral sanitizer to clean up Lister deck four.<br />
![](../images/bachar.png)**Cmdr Bachar:** I've seen much worse<br />
![](../images/zox.png)**Zox:** SO....Who wants some pancakes? I've got this amazing new spatula and pan!<br />
![](../images/bachar.png)**Cmdr Bachar:** You know, on that topic, what the hell got into you with the chef thing?<br />
*Skig raises eyebrow at Zox.*<br />
![](../images/bachar.png)**Cmdr Bachar:** Did you forget you were on an intelligence mission and just decide to start a side career as a chef?<br />
![](../images/zox.png)**Zox:** It was the best I could do with no plan, no costume, and no alibi<br />
![](../images/murry.png)**Hailey Murry:** But you had a costume<br />
![](../images/zox.png)**Zox:** All cultures have some sort of liking of food, however strange, except those energy monsters.<br />
![](../images/bachar.png)**Cmdr Bachar:** Little lesson in intelligence work: if you need a cover identity, it should be someone subtle, forgettable, and unremarkable<br />
![](../images/zox.png)**Zox:** Ah ha! But that's just what they are looking for!<br />
![](../images/bachar.png)**Cmdr Bachar:** Not a 2 meter tall dinosaur chef with a shitty accent<br />
**Throk:** Throk not understand many things, but Throk think there is issue with concept that Security Chief operates entirely on instinct with no regard for planning or operational security.<br />
*Skig offers Throk some popcorn.*<br />
**Throk:** Does this come with toy in bottom?<br />
![](../images/skig.png)**Skig:** Only one way to find out.<br />
![](../images/bachar.png)**Cmdr Bachar:** You put on grey civilian clothes, grab a bottle of booze, and keep your moth shut<br />
![](../images/zox.png)**Zox:** It's only shitty because you are  a legitmate human,not an uncultured person who has only heard of earth chefs in caricature<br />
...
**Throk:** Throk roll assist to help Counselor with job duties!<br />
...
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 25]**<br />
![](../images/bachar.png)**Cmdr Bachar:** Knock it off you two<br />
![](../images/zox.png)**Zox:** After mission jitters can only be calmed by food. Enjoy!<br />
...
![](../images/bachar.png)**Cmdr Bachar:** You're like small children. "Keep your hands to yourselves or I'm turning this ship around."<br />
**Zox: [ CONTROL  (11) +  SCIENCE  (4)]
[Focus: Xenobiology ]
[Successes: 4] [Complications: 0]
Success with 3 momentum [3d20 = 22]**<br />
![](../images/zox.png)**Zox:** Can you give me a hand, T'kor?<br />
![](../images/skig.png)**Skig:** Operationally speaking, I don't think that would be wise Commander. Not that I don't sympathsize with the sentiment.<br />
![](../images/bachar.png)**Cmdr Bachar:** At least you didn't throw anyone to the wolves to save wear on ODN line or something<br />
*Skig shrugs.*<br />
![](../images/bachar.png)**Cmdr Bachar:** I may have been... a bit harsh on your earlier<br />
**T'Kor:** Of course! I've got two to spare right now<br />
*Skig looks at Bachar.*<br />
![](../images/zox.png)**Zox:** Yee haw! Pan Fried Hot Cakes<br />
![](../images/zox.png)**Zox:** Cooked on genu'ine tritanium cookware!<br />
![](../images/skig.png)**Skig:** It's understandable.<br />
...
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 21]**<br />
**Throk:  [Total: 5] [Effects: 2] [7dChallenge = 5]**<br />
**Skig:  [2d20 = 28]**<br />
**Zox:  [5d20 = 56]**<br />
**Zox:  [Total: 4] [Effects: 3] [5dChallenge = 4]**<br />
**Hailey Murry:  [4d20 = 53]**<br />
...
![](../images/bachar.png)**Cmdr Bachar:** I cannot stress enough how critical it is that you keep your mouths shut<br />
**Zox: [ CONTROL  (11) +  SECURITY  (4)]
[Focus: Espionage ]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 19]**<br />
...
![](../images/zox.png)**Zox:** I. Know. Nothing!<br />
**Skig: [ REASON  (10) +  SECURITY  (3)]
[Focus: System Maintenance ]
[Successes: 3] [Complications: 0]
Success with 2 momentum [2d20 = 7]**<br />
<font color="#005500">Masakari (Zox): 6 rolls &lt;= 5</font><br />
**Zox:  [Total: 4] [Effects: 3] [4dChallenge = 4]**<br />
**Zox:  [Total: 4] [Effects: 1] [4dChallenge = 4]**<br />
**Skig:  [Total: 1] [Effects: 1] [3dChallenge = 1]**<br />
**Hailey Murry:  [Total: 7] [Effects: 2] [6dChallenge = 7]**<br />
**T'Kor: [ INSIGHT  (7) +  CONN  (3)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 17]**<br />
![](../images/bachar.png)**Cmdr Bachar:** You all seem to be oblivious to the political and structural forces at play here, but this is a very dangerous situation<br />
**T'Kor:** I am used to dangerous situations<br />
![](../images/zox.png)**Zox:** I am a lo'var n'at a faightar.<br />
![](../images/zox.png)**Zox:** Wait.<br />
![](../images/zox.png)**Zox:** Hey, it may be crime, but at least it's organized.<br />
![](../images/bachar.png)**Cmdr Bachar:** If we need to meet to discuss anything, file a request for duty roster adjustment requesting a night shift rotation for "concurrency requirements"<br />
![](../images/zox.png)**Zox:** Not Bocce Ball holodeck?<br />
*Cmdr Bachar turns to Zox*<br />
![](../images/bachar.png)**Cmdr Bachar:** This isn't a punning matter Commander<br />
![](../images/bachar.png)**Cmdr Bachar:** All of our careers and our lives could be at risk here<br />
![](../images/bachar.png)**Cmdr Bachar:** Did you even see who was conducting the captain's command review?<br />
**Throk:** Throk expect to die in valiant last stand, it totally okay.<br />
![](../images/murry.png)**Hailey Murry:** Understood, Commander<br />
![](../images/zox.png)**Zox:** Oh. I did not see that.<br />
![](../images/bachar.png)**Cmdr Bachar:** Admiral Nechayev, Admiral Ross and Admiral Nakamura<br />
![](../images/bachar.png)**Cmdr Bachar:** The chief of staff of Starfleet, the head of fleet command and the head of the Corps of Engineers<br />
**Zox: [ INSIGHT  (8) +  SECURITY  (4)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 26]**<br />
![](../images/bachar.png)**Cmdr Bachar:** The three highest ranking admirals in Starfleet<br />
![](../images/bachar.png)**Cmdr Bachar:** Flew out to a starbase on the edge of Federation space to conduct a command review of a first-time captain of the oldest ship in Starfleet<br />
![](../images/zox.png)**Zox:** Maybe they are just bored and in need of a war, so they just review the troops?<br />
![](../images/bachar.png)**Cmdr Bachar:** Take off that chef hat, it seems to be cutting off the bloodflow to your brain<br />
*Throk thinks about saying something witty, realizes it is not witty, decides to keep mouth shut for once.*<br />
![](../images/zox.png)**Zox:** Okay, but if cold-blood is flowing, that would indicate they do not think Baras suitable for this.<br />
![](../images/murry.png)**Hailey Murry:** Ah, I take it you never actually left Intelligence? <br />
*Zox glares at Hailey.*<br />
![](../images/bachar.png)**Cmdr Bachar:** No, I transfered to fleet command after the war, I wanted a normal career<br />
![](../images/bachar.png)**Cmdr Bachar:** But everything about the Lister is suspicious: a 90 year old ship pulled out of mothballs, given to a 73 year old captain who has failed the command proficiency exam 12 times, staffed with Starfleet's least wanted, and then assigned to a prestigous posting along the Cardassian border<br />
![](../images/zox.png)**Zox:** It's good cover to sponge up intel using the group-w bench.<br />
![](../images/bachar.png)**Cmdr Bachar:** Every senior officer on the ship has an active intelligence file open. I can't view them with my clearance, but I can see that they exist<br />
![](../images/bachar.png)**Cmdr Bachar:** It stinks<br />
...
![](../images/murry.png)**Hailey Murry:** Ahhh<br />
![](../images/murry.png)**Hailey Murry:** That is...really troublesome<br />
![](../images/murry.png)**Hailey Murry:** So wait, what happened what you got kidnapped? <br />
![](../images/bachar.png)**Cmdr Bachar:** I was kept unconcious<br />
![](../images/murry.png)**Hailey Murry:** Drat. And you think Starfleet is up to something? <br />
![](../images/zox.png)**Zox:** Possible that memory engrams were still being carved even if sub or unconcious?<br />
![](../images/bachar.png)**Cmdr Bachar:** I don't know who is pulling the strings, but the Starfleet triumverate wouldn't be here unless one of them is involved<br />
![](../images/murry.png)**Hailey Murry:** Involved in something sketchy? <br />
![](../images/bachar.png)**Cmdr Bachar:** I don't know what game they're playing, but I don't intend to be a pawn<br />
![](../images/skig.png)**Skig:** Or they expect us to not find something, given the situation Bachar outlined and as a result have plausible denialability for whatever the outcome is.<br />
![](../images/bachar.png)**Cmdr Bachar:** That ledger that led you to Empok Nor? I included it in the report we filed on our last encounter with the Aldazed<br />
![](../images/bachar.png)**Cmdr Bachar:** Starfleet intelligence should have been able to find anything you were able to<br />
![](../images/bachar.png)**Cmdr Bachar:** But the file on that report shows "No useful intelligence"<br />
![](../images/zox.png)**Zox:** But they didn't have Ishemok's keen eyes pooring over data<br />
![](../images/bachar.png)**Cmdr Bachar:** No, someone buried it<br />
![](../images/murry.png)**Hailey Murry:** That's exceptionally troublesome<br />
![](../images/bachar.png)**Cmdr Bachar:** Until we figure out what is going on, no one else enters the circle of trust on this<br />
![](../images/bachar.png)**Cmdr Bachar:** Not even the captain<br />
*Skig looks at datapad.*<br />
![](../images/bachar.png)**Cmdr Bachar:** We need to get ahead of this thing, so we don't end up buried under it<br />
![](../images/murry.png)**Hailey Murry:** Absolutely. I imagine they put the Captain in charge to keep things relatively under control. He's very passive for a captain<br />
>♫♫♫Dramatic Music String♫♫♫<br />

>---------CUT TO CREDITS-------<br />

![](../images/zox.png)**Zox:** You need to explain this to Ishemok <br />
