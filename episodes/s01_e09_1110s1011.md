...
![](../images/bachar.png)**Commander Bachar:** We need to move quickly here, we have a limited window here to act on some of this intelligence. We need to decide what we want to prioritize following up.<br />
...
![](../images/zox.png)**Zox:** Hrm. This is a real boggle, as the humans say.<br />
![](../images/zox.png)**Zox:** Ilitz Nebula seems the best to me. <br />
![](../images/zox.png)**Zox:** Either that or set up an ambush in Jasanis' apartment. <br />
**Hailey Murry: [ INSIGHT  (12) +  SECURITY  (2)]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 13]**<br />
![](../images/bachar.png)**Commander Bachar:** I think we should track down this Brovena. She seems to know a lot about Jasanis' operation.<br />
![](../images/malat.png)**Lt. Malat:** Fuck that ma'am. We should go to this exchange with Jasanis' buyers and crack her skull open. We know where she's going to be, when she's going to be there, and she doesn't know that we know. I say me and Zox go there with a security team and kick her ass.<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** Our prior direct confrontations with the Orions have not always gone well. Perhaps it would be more wise to investigate these coordinates in the Ilitz Nebula, they seem to have a facility there conducting research. A purely research focused site may be less heavily guarded.<br />
*Zox looks at both Malat and the twins.*<br />
![](../images/zox.png)**Zox:** Yes! These plans are good!<br />
![](../images/zox.png)**Zox:** Bully small research humanoids, or bully trained guards! I like both!<br />
![](../images/malat.png)**Lt. Malat:** Exactly, Jasanis is going to be at this deal in 4 days, we should get there first and plan an ambush<br />
![](../images/skig.png)**Skig:** I believe the upcoming operation with the Lister will require my full attention. If we are following multiple leads, we would need plausible alibis for where people are and also to maintain the appearance of a functional crew.<br />
![](../images/zox.png)**Zox:** Yeah I think if we came in force and with proper equipment, we'd be fine. Empok nor was goofy!<br />
![](../images/bachar.png)**Commander Bachar:** You have no idea who these buyers are, that could be an extremely dangerous situation to walk into<br />
![](../images/murry.png)**Hailey Murry:** Might be easy to blow up, though<br />
![](../images/bachar.png)**Commander Bachar:** I agree Skig, it would be hard to justify you or I leaving the Lister during this mission<br />
![](../images/murry.png)**Hailey Murry:** Take a couple shots at the buyers, maybe hit a guard or two, make it seem like an ambush<br />
![](../images/skig.png)**Skig:** In fact, if Zox wishes to engage in his normal plan of action, I have just the solution for him.<br />
![](../images/murry.png)**Hailey Murry:** We could ruin the entire plan with the shipment<br />
![](../images/zox.png)**Zox:** A new techno gadget? <br />
...
![](../images/zox.png)**Zox:** Good criminals set down too many leads; there are no dangerous objects, just dangerous people. Jasanis should be priority. <br />
![](../images/murry.png)**Hailey Murry:** On the other hand, that research facility...<br />
![](../images/murry.png)**Hailey Murry:** If they strike a deal, and we take that out at the same time<br />
![](../images/zox.png)**Zox:** They aren't used to being discovered and outgunned.<br />
![](../images/murry.png)**Hailey Murry:** That might end things even sooner<br />
![](../images/murry.png)**Hailey Murry:** Are they going to be outgunned?<br />
![](../images/murry.png)**Hailey Murry:** We have two or three powerful factions meeting <br />
*Zox appreciates Tellurite ingenutiy and stubbon dedication.*<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** It is not clear who these buyers are, but they do not seem intimidated by Jasanis,so they may indeed be quite dangerous in their own right<br />
![](../images/zox.png)**Zox:** She beguiles them with her forked tongue!<br />
![](../images/zox.png)**Zox:** Purely from cost-benefit, and with the Federations desire to prevent harm and destruction, removing Jasanis has the clearest benefit and the least ambiguity. <br />
![](../images/malat.png)**Lt. Malat:** Hell yes sir<br />
*Lt. Malat fist bumps Zox*<br />
![](../images/zox.png)**Zox:** Unfortunately, we don't have Romulan Interrogation methods, so even if we catch one of her collaborators, it might just go cold.<br />
![](../images/bachar.png)**Commander Bachar:** I don't love this plan, you'll be walking into a completely undknown situation with potentially 2 different powerful adversaries. And you won't have the Lister for backup. Are you sure you want to do this?<br />
![](../images/murry.png)**Hailey Murry:** I'm not. I personally don't vote for it until we can figure out who they are. I think we could probably throw things off over there, but I think we can do better at their research facility<br />
![](../images/malat.png)**Lt. Malat:** I'm with Zox, cut the head off the snake<br />
![](../images/zox.png)**Zox:** Yeah!<br />
**Zox: [ INSIGHT  (8) +  SECURITY  (4)]
[Successes: 1] [Complications: 0]
Success with 0 momentum [2d20 = 24]**<br />
![](../images/skig.png)**Skig:** I question the wisdom of taking my Mecha-Suit Prototype into a combat situation where it could possibly be seriously damaged and I am unable to retrieve it.<br />
![](../images/skig.png)**Skig:** Oh, and Zox might get hurt.<br />
![](../images/zox.png)**Zox:** I can help you install a subspace communicator giving full combat logging back to the Lister. You might lose the suit, but you'd always get the data for Kaiju 2.0<br />
![](../images/zox.png)**Zox:** And the suit is your idea, the materials are replaceable.<br />
...
![](../images/skig.png)**Skig:** True, I did save a Blueprint against Old Faithful's replicator. I had to use that one because the suit violates 24 different Starfleet Safety Protocols and I didn't want to have to file a bunch of complaints about my activities to myself for deactiving replicator security functions.<br />
*Zox puts on a pair of glasses and tries to look cool*<br />
![](../images/zox.png)**Zox:** What you need is Field Testing Skig, right?<br />
![](../images/zox.png)**Zox:** And there's no better way to field test than exposing the suit to the optimal conditions, where it can act as a force multiplier in the right hands.<br />
![](../images/skig.png)**Skig:** Right, I will see if I can adjust it to work with Throk.<br />
![](../images/zox.png)**Zox:** Jasanis or her goons probably don't think a small team can match them, and they will see an army from a mile out.<br />
![](../images/skig.png)**Skig:** Oh, you meant "your hands." Got it.<br />
<font color="#005500">Masakari (Zox): 'Don't fear the dino-reaper'</font><br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** The Ilitz Nebula is in Breen space, and the Porea Synet cluster is in Cardassian territory. We would need to secure entry documents for either plan to work<br />
...
[Successes: 0] [Complications: 1]
Failed on DC: 1 [d20 = 20]**<br />
![](../images/malat.png)**Lt. Malat:** And we need a ship, the Lister is stuck here<br />
![](../images/skig.png)**Skig:** The Lister is not stuck, it is fully functional and capable of moving.<br />
![](../images/malat.png)**Lt. Malat:** Thank you ma'am<br />
![](../images/skig.png)**Skig:** Wait, you mean, "It has to babysit all the Sovereign ships".<br />
![](../images/zox.png)**Zox:** Hrm. We need a non-federation ship.<br />
![](../images/zox.png)**Zox:** Something really scumy like a Ferengi one<br />
![](../images/malat.png)**Lt. Malat:** If we're going after Jasanis we want something with some teeth, if we're going to this research facility we need something that doesn't draw too much attention<br />
![](../images/murry.png)**Hailey Murry:** I don't think the Lister is babysitting anything, given our position<br />
![](../images/malat.png)**Lt. Malat:** If we're going to both we need divine assistance<br />
**Hailey Murry: [ INSIGHT  (12) +  COMMAND  (1)]
[Focus: Bureaucracy ]
[Successes: 1] [Complications: 1]
Success with 0 momentum [2d20 = 27]**<br />
![](../images/bachar.png)**Commander Bachar:** I don't trust Kurij, not enough on this one<br />
![](../images/bachar.png)**Commander Bachar:** But after this week maybe we don't need to be so paranoid<br />
![](../images/murry.png)**Hailey Murry:** She's a great pilot and knows enough about ships that any records she makes while searching will be lost in the shuffle<br />
![](../images/bachar.png)**Commander Bachar:** While you're away, I plan to take advantage of the situation here to figure out what is going on<br />
![](../images/bachar.png)**Commander Bachar:** Admirals Ross and Nechayev were inexplicably involved in the Captain's command review, and now both are here commanding a fleet that the Lister is equally inexplicably assigned to<br />
*Zox begins playing with a Mothra and Ghidora figures while the adults do some adulting.*<br />
![](../images/bachar.png)**Commander Bachar:** I plan to get to the bottom of that with whoever stays behind, so don't any of you plan on getting any time off<br />
**Hailey Murry: [ INSIGHT  (12) +  SECURITY  (2)]
[Focus: Bureaucracy ]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 16]**<br />
...
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 25]**<br />
![](../images/skig.png)**Skig:** I will assist the Commander with those investigations, since I will be here to ensure the Lister outperforms all other vessels in our Gravitronic Radiation Deflection.<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** It is highly unlikely that the Lister will outperform Sovereign class flagships that are 100 years more modern<br />
![](../images/twins.png)**Lt. Cmdrs 11 and 10:** But we admire your confidence<br />
![](../images/skig.png)**Skig:** You are likely correct, I guess I will accept outperforming our expectations, which at this point probably involves, "not requiring more time in dry dock".<br />
*Skig sighs.*<br />
...
![](../images/zox.png)**Zox:** Good News everyone! I've located the perfect vessel in the Starfleet's hangars, theyll never know!<br />
![](../images/zox.png)**Zox:** Coupled with these stellar documents, we have an easy pass into the Ilitz Nebula<br />
![](../images/bachar.png)**Commander Bachar:** Ok, so it's settled. Murry, you lead a team to the Ilitz nebula and investigate the facility there. In the meantime, I will draw up a duty roster to cover for your absence and Skig: get down to engineering and make sure we aren't killed by radiation in the meantime<br />
![](../images/skig.png)**Skig:** Breen is not spelled with triple umlauts.<br />
![](../images/skig.png)**Skig:** Aye aye Commander!<br />

*Skig gleefully leaves to do important engineering stuff.*<br />
![](../images/zox.png)**Zox:** Well Murray, you convinced us all to take the path with less violence, which is good because the effects guy is out this episode on PTO. But that means you need to pick your SNEAKIEST crewmates, who's it gonna be?<br />
