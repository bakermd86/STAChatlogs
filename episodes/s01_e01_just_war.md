...
![](../images/skig.png) **Skig:** We could try moving out of range and see if the warp field re-estbalishes itself?<br />
...
![](../images/skig.png) **Skig:** Have you raised the shields? And were the shields up prior to Viraseti's disappearance?<br />
...
![](../images/zox.png) **Zox:** Can you create some way to stabilize the interference?<br />
*Skig shrugs.*<br />
...
![](../images/murry.png) **Hailey Murry:** Let's check with each of the delegates individually and get their side of how development and exploration of the valley has been occuring<br />
...
![](../images/zox.png) **Zox:** No more big words with these natives. Look, here's what we came for. <br />
...
![](../images/zox.png) **Zox:** Oh. Okay that sound like a plan. I am unimpressed by the mating rituals of your species, however.<br />
...
![](../images/zox.png) **Zox:** Great work Kolea, we are all still alive.<br />
...
![](../images/zox.png) **Zox:** Some find it....ribbiting.<br />
...
![](../images/zox.png) **Zox:** Very well. Where is this crawler?<br />
...
![](../images/skig.png) **Skig:** Well, conviently, using the phaser bank on the ship might have brought both factions together so our shipboard Counselor can negotiate a truce with both sides.  Or create the complication of uniting both sides against us.<br />
...
![](../images/zox.png) **Zox:** Skig, those ramshackle contraptions look to be made from real Osalan tech, Can we not EMP them both to prevent a bloody conflict?<br />
...
![](../images/skig.png) **Skig:** It might be possible to modulate the phaser banks or use the sensor arrays to disrupt their electrical systems.<br />
...
![](../images/zox.png) **Zox:** Sounds like a plan to me.<br />
**Lt. Malat:** Good luck disabling their spears and bows and arrows<br />
![](../images/skig.png) **Skig:** I agree, we should be able to disable their vehicles if they engage in hostilities towards the away team.<br />
![](../images/skig.png) **Skig:** However, this does not stop them from stabbing the away team or killing the captives.<br />
**Dr. Zerra:** Their may be a diplomatic solution, have we tried hailing them?<br />
![](../images/skig.png) **Skig:** Right, have they engaged in any hostilities or opened communications with them?<br />
![](../images/zox.png) **Zox:** Do we have a lock on any com badges eminating from the crawlers?<br />
...
![](../images/skig.png) **Skig:** We are operating from a position of strength in that they know we have superior technology and have used it already. They will demand this technology in exchange for freeing the captives. Obviously the Prime Directive prohibits this response.<br />
...
![](../images/skig.png) **Skig:** Perhaps we can find out what they want, and negotiate some palatable solution where they are each given half of some more advanced medical/life preserving technology and taught they need to work together to make the best use of it?<br />
...
![](../images/skig.png) **Skig:** Or perhaps something agricultural.<br />
![](../images/zox.png) **Zox:** I like the idea of hailing first. We have enough prisoners to negotiate for whatever Starfleet was captured by either side.<br />
**Commander Bachar:** Sounds like the best plan we have. <br />
![](../images/skig.png) **Skig:** Okay, let's hail one or both sides, if they do not have communications capable equipment, is it conventional "wave the white flag and invite them over for tea?"<br />
...
![](../images/zox.png) **Zox:** What if we just made it rain sufficiently to disable their crawlers?<br />
![](../images/skig.png) **Skig:** Pocket Dimension created by the Traveler to preserve the inhabitants of the valley from the orbital bombardment that destroyed the city that was imprisoning him.  At least, that is the current working theory.<br />
...
![](../images/zox.png) **Zox:** Oh I agree. <br />
...
![](../images/zox.png) **Zox:** It might be that too<br />
...
![](../images/skig.png) **Skig:** Murry, can you go to Briefing Room 2 and prepare to meet our guests?<br />
![](../images/skig.png) **Skig:** I need a security detail with phasers to join Murry in Briefing Room 2.<br />
...
![](../images/skig.png) **Skig:** Murry, I believe communications in person are the best way solve this problem.<br />
...
![](../images/skig.png) **Skig:** Oh, that button needs to be pressed at the same time. This is why I usually let other people push the transporter buttons.<br />
**Hailey Murry: [ DARING  (11) +  SECURITY  (2)]
[Focus: Voth Calisthenics ]
[Successes: 2] [Complications: 0]
Success with 1 momentum [2d20 = 16]**<br />
...
![](../images/skig.png) **Skig:** The Traveller is departing and taking his home with him.<br />
>♫♫♫Mysterious Music Sting♫♫♫<br />
